...
/**
 * Conjunto de dados referentes a transação de débito.
 */
@ApiModel(description = "Conjunto de dados referentes a transação de débito.")
...
public class Debit {
  ...
  private String cardholderMobile = null;
  ...
  public Debit cardholderMobile(String cardholderMobile) {
    this.cardholderMobile = cardholderMobile;
    return this;
  }

   /**
   * Telefone do portador do cartão. Obrigatório para Visa.
   * @return cardholderMobile
  **/
  @ApiModelProperty(example = "5551999887766", value = "Telefone do portador do cartão. Obrigatório para Visa.")
  ...
  public Debit softDescriptor(String softDescriptor) {
  ...
  **/
  ...
  public Debit dynamicMcc(BigDecimal dynamicMcc) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Debit debit = (Debit) o;
    return Objects.equals(this.cardholderMobile, debit.cardholderMobile) &&
        Objects.equals(this.softDescriptor, debit.softDescriptor) &&
        Objects.equals(this.dynamicMcc, debit.dynamicMcc) &&
        Objects.equals(this.card, debit.card);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cardholderMobile, softDescriptor, dynamicMcc, card);
  }
  ...
  public String toString() {
    ...
    sb.append("    cardholderMobile: ").append(toIndentedString(cardholderMobile)).append("\n");
