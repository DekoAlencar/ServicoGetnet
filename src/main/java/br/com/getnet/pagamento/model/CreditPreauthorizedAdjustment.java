...
/**
 * Conjunto de dados para ajuste de valor de Pré-Autorização.
 */
@ApiModel(description = "Conjunto de dados para ajuste de valor de Pré-Autorização.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-01-25T16:02:55.559Z")
public class CreditPreauthorizedAdjustment {
  ...
  public CreditPreauthorizedAdjustment amount(Integer amount) {
    this.amount = amount;
    return this;
  }

   /**
   * Valor do ajuste de Pré-Autorização.
   * @return amount
  **/
  @ApiModelProperty(example = "19990", required = true, value = "Valor do ajuste de Pré-Autorização.")
  ...
  public CreditPreauthorizedAdjustment currency(String currency) {
   ...
   * @return currency
  **/
  @ApiModelProperty(example = "BRL", required = true, value = "Identificação da moeda da transação original (Consultar código em \"https://www.currency-iso.org/en/home/tables/table-a1.html\").")
  ...
  public CreditPreauthorizedAdjustment softDescriptor(String softDescriptor) {
  ...
  **/
  ...
  public CreditPreauthorizedAdjustment dynamicMcc(BigDecimal dynamicMcc) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreditPreauthorizedAdjustment creditPreauthorizedAdjustment = (CreditPreauthorizedAdjustment) o;
    return Objects.equals(this.amount, creditPreauthorizedAdjustment.amount) &&
        Objects.equals(this.currency, creditPreauthorizedAdjustment.currency) &&
        Objects.equals(this.softDescriptor, creditPreauthorizedAdjustment.softDescriptor) &&
        Objects.equals(this.dynamicMcc, creditPreauthorizedAdjustment.dynamicMcc);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, currency, softDescriptor, dynamicMcc);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreditPreauthorizedAdjustment {\n");
