...
import br.com.getnet.pagamento.model.Period;
import java.io.IOException;

/**
 * Informações sobre o plano.
 */
@ApiModel(description = "Informações sobre o plano.")
...
public class SubscriptionPlanResponse {
   ...
   */
  @JsonAdapter(PaymentTypesEnum.Adapter.class)
  public enum PaymentTypesEnum {
    CREDIT_CARD("credit_card");

    private String value;

    PaymentTypesEnum(String value) {
      this.value = value;
    }
    ...
    public static PaymentTypesEnum fromValue(String text) {
      for (PaymentTypesEnum b : PaymentTypesEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<PaymentTypesEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final PaymentTypesEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public PaymentTypesEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return PaymentTypesEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("payment_types")
  private PaymentTypesEnum paymentTypes = null;

  @SerializedName("sales_tax")
  private Integer salesTax = null;
  ...
  public SubscriptionPlanResponse planId(String planId) {
    this.planId = planId;
    return this;
  }
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(example = "Plano flex", value = "Nome do plano.")
   ...
   * @return description
  **/
  @ApiModelProperty(example = "Plano flex", value = "Descrição do plano.")
  ...
  public SubscriptionPlanResponse amount(Integer amount) {
    this.amount = amount;
    return this;
  }
   ...
   * @return amount
  **/
  @ApiModelProperty(example = "19990", value = "Valor do plano.")
  ...
  public SubscriptionPlanResponse currency(String currency) {
  ...
  **/
  ...
  public SubscriptionPlanResponse paymentTypes(PaymentTypesEnum paymentTypes) {
   ...
   * @return paymentTypes
  **/
  @ApiModelProperty(example = "", value = "Tipos de pagamentos aceitos.")
  public PaymentTypesEnum getPaymentTypes() {
    return paymentTypes;
  }

  public void setPaymentTypes(PaymentTypesEnum paymentTypes) {
    this.paymentTypes = paymentTypes;
  }

  public SubscriptionPlanResponse salesTax(Integer salesTax) {
   ...
   * @return salesTax
  **/
  @ApiModelProperty(value = "Valor de impostos.")
  ...
  public SubscriptionPlanResponse productType(ProductTypeEnum productType) {
  ...
  **/
  ...
  public SubscriptionPlanResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
  **/
  @ApiModelProperty(example = "active", value = "Status do plano.")
  ...
  public SubscriptionPlanResponse period(Period period) {
    this.period = period;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.planId, subscriptionPlanResponse.planId) &&
        ...
        Objects.equals(this.amount, subscriptionPlanResponse.amount) &&
        Objects.equals(this.currency, subscriptionPlanResponse.currency) &&
        Objects.equals(this.paymentTypes, subscriptionPlanResponse.paymentTypes) &&
        Objects.equals(this.salesTax, subscriptionPlanResponse.salesTax) &&
        Objects.equals(this.productType, subscriptionPlanResponse.productType) &&
        Objects.equals(this.status, subscriptionPlanResponse.status) &&
        Objects.equals(this.period, subscriptionPlanResponse.period);
  }

  @Override
  public int hashCode() {
    return Objects.hash(planId, name, description, amount, currency, paymentTypes, salesTax, productType, status, period);
  }
