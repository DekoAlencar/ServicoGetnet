...
public class Boleto {
  ...
  private ProviderEnum provider = ProviderEnum.SANTANDER;

  public Boleto ourNumber(String ourNumber) {
   ...
   * @return ourNumber
  **/
  @ApiModelProperty(example = "000001946598", value = "Denominado pelos bancos como \"Nosso Número\". É a identificação única do boleto no sistema de cobrança. É composto por regras que variam em função do banco e do serviço de cobrança. Por exemplo, no caso do Santander existem duas formas de se numerar. 1) Se cliente quem numera, deve informar o dígito verificador (DV); 2) Se o cliente omitir o número, o Banco fica encarregado da geração de um sequêncial, sem um DV. (sem máscara)")
  ...
  public Boleto documentNumber(String documentNumber) {
  ...
  **/
  @ApiModelProperty(example = "170500000019763", value = "Seu Número. Número controlado pelo cliente, geralmente é gerenciado pelo sistema que está gerando o boleto. (sem máscara)")
  ...
  public Boleto expirationDate(String expirationDate) {
  ...
  **/
  @ApiModelProperty(example = "16/11/2017", value = "Data do vencimento do boleto. Caso não seja informado, será considerado o número de dias padrão pré-cadastrado para o vencimento.")
  ...
  public Boleto instructions(String instructions) {
   ...
   * @return instructions
  **/
  @ApiModelProperty(example = "Não receber após o vencimento", value = "Instruções a serem impressas no boleto (colocar quebra de linha a cada 100 caracteres, máximo 10 linhas).")
  ...
  public Boleto provider(ProviderEnum provider) {
   ...
   * @return provider
  **/
  @ApiModelProperty(example = "santander", value = "Banco provedor.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.ourNumber, boleto.ourNumber) &&
        Objects.equals(this.documentNumber, boleto.documentNumber) &&
        Objects.equals(this.expirationDate, boleto.expirationDate) &&
        Objects.equals(this.instructions, boleto.instructions) &&
        Objects.equals(this.provider, boleto.provider);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ourNumber, documentNumber, expirationDate, instructions, provider);
  }
