...
public class Error {
  ...
  **/
  ...
  public Error name(String name) {
   ...
   /**
   * Nome do modulo ou sistema em que o erro ocorreu.
   * @return name
  **/
  @ApiModelProperty(value = "Nome do modulo ou sistema em que o erro ocorreu.")
  ...
  **/
  ...
  public Error details(List<Details> details) {
    this.details = details;
    return this;
  }

  public Error addDetailsItem(Details detailsItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(message, name, statusCode, details);
  }
