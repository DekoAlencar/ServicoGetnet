...
import br.com.getnet.pagamento.model.Shipping;
 ...
 */
@ApiModel(description = "Conjunto de dados referentes a transação de pagamento")
...
public class PaymentDebit {
  ...
  public PaymentDebit sellerId(String sellerId) {
  ...
  **/
  ...
  public PaymentDebit amount(Integer amount) {
    this.amount = amount;
    return this;
  }
   ...
   * @return amount
  **/
  @ApiModelProperty(example = "100", required = true, value = "Valor da compra em centavos.")
  ...
  public PaymentDebit currency(String currency) {
  ...
  **/
  ...
  public PaymentDebit order(Order order) {
    this.order = order;
    return this;
  }
  ...
  **/
  ...
  public PaymentDebit customer(Customer customer) {
  ...
  **/
  ...
  public PaymentDebit device(Device device) {
    this.device = device;
    return this;
  }
  ...
  **/
  ...
  public PaymentDebit shippings(List<Shipping> shippings) {
    this.shippings = shippings;
    return this;
  }

  public PaymentDebit addShippingsItem(Shipping shippingsItem) {
  ...
  **/
  ...
  public PaymentDebit debit(Debit debit) {
    this.debit = debit;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentDebit paymentDebit = (PaymentDebit) o;
    return Objects.equals(this.sellerId, paymentDebit.sellerId) &&
        Objects.equals(this.amount, paymentDebit.amount) &&
        Objects.equals(this.currency, paymentDebit.currency) &&
        Objects.equals(this.order, paymentDebit.order) &&
        Objects.equals(this.customer, paymentDebit.customer) &&
        Objects.equals(this.device, paymentDebit.device) &&
        Objects.equals(this.shippings, paymentDebit.shippings) &&
        Objects.equals(this.debit, paymentDebit.debit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sellerId, amount, currency, order, customer, device, shippings, debit);
  }
