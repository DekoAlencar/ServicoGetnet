...
/**
 * Conjunto de dados da solicitação de cancelamento.
 */
@ApiModel(description = "Conjunto de dados da solicitação de cancelamento.")
...
public class CancelQueryResponse {
  ...
  private String terminalNsu = null;
  ...
  /**
   * Tipo da transação original. Pagamento à vista ou parcelado.
   */
  ...
  private Integer numberInstallments = null;

  @SerializedName("amount")
  private Integer amount = null;

  @SerializedName("cancel_amount")
  private Integer cancelAmount = null;

  @SerializedName("status_processing_cancel_code")
  private String statusProcessingCancelCode = null;

  @SerializedName("status_processing_cancel_message")
  private String statusProcessingCancelMessage = null;

  public CancelQueryResponse sellerId(String sellerId) {
   ...
   * @return sellerId
  **/
  @ApiModelProperty(example = "6eb2412c-165a-41cd-b1d9-76c575d70a28", value = "Código de identificação do e-commerce.")
  ...
  public CancelQueryResponse paymentId(String paymentId) {
   ...
   * @return paymentId
  **/
  @ApiModelProperty(example = "06f256c8-1bbf-42bf-93b4-ce2041bfb87e", value = "Código de identificação do pagamento da transação original.")
  ...
  public CancelQueryResponse cancelRequestAt(String cancelRequestAt) {
  ...
  **/
  @ApiModelProperty(example = "2017-11-16T16:30:30Z", value = "Data da solicitação de cancelamento.")
  ...
  public CancelQueryResponse cancelRequestId(String cancelRequestId) {
  ...
  **/
  @ApiModelProperty(example = "20171117084237501", value = "Identificador do request de cancelamento.")
  ...
  public CancelQueryResponse cancelCustomKey(String cancelCustomKey) {
    this.cancelCustomKey = cancelCustomKey;
    return this;
  }

   /**
   * Chave do cliente utilizada para identificar uma solicitação de cancelamento. (Chave deve ser única por transação).
   * @return cancelCustomKey
  **/
  @ApiModelProperty(example = "4ec33ee18f9e45bfb73c5c30667f9006", value = "Chave do cliente utilizada para identificar uma solicitação de cancelamento. (Chave deve ser única por transação).")
  ...
  public CancelQueryResponse terminalNsu(String terminalNsu) {
   ...
   * @return terminalNsu
  **/
  @ApiModelProperty(example = "013978", value = "Código de Autorização gerado pelo Emissor quando a transação é realizada com sucesso.")
  ...
  public CancelQueryResponse acquirerTransactionId(String acquirerTransactionId) {
    this.acquirerTransactionId = acquirerTransactionId;
    return this;
  }

   /**
   * Código do adquirente da transação original.
   * @return acquirerTransactionId
  **/
  @ApiModelProperty(example = "113880914", value = "Código do adquirente da transação original.")
  ...
  public CancelQueryResponse transactionDate(String transactionDate) {
  ...
  **/
  @ApiModelProperty(example = "17052017", value = "Data da transação original.")
  ...
  public CancelQueryResponse currency(String currency) {
    this.currency = currency;
    return this;
  }

   /**
   * Identificação da moeda da transação original (Consultar código em \&quot;https://www.currency-iso.org/en/home/tables/table-a1.html\&quot;).
   * @return currency
  **/
  @ApiModelProperty(example = "BRL", value = "Identificação da moeda da transação original (Consultar código em \"https://www.currency-iso.org/en/home/tables/table-a1.html\").")
  ...
  public CancelQueryResponse transactionType(TransactionTypeEnum transactionType) {
  ...
  **/
  @ApiModelProperty(example = "FULL", value = "Tipo da transação original. Pagamento à vista ou parcelado.")
  ...
  public CancelQueryResponse numberInstallments(Integer numberInstallments) {
    this.numberInstallments = numberInstallments;
    return this;
  }

   /**
   * Número de parcelas da transação original.
   * @return numberInstallments
  **/
  @ApiModelProperty(example = "1", value = "Número de parcelas da transação original.")
  ...
  public CancelQueryResponse amount(Integer amount) {
    this.amount = amount;
    return this;
  }
   ...
   * @return amount
  **/
  @ApiModelProperty(example = "19990", value = "Valor da transação original.")
  ...
  public CancelQueryResponse cancelAmount(Integer cancelAmount) {
    this.cancelAmount = cancelAmount;
    return this;
  }

   /**
   * Valor da solicitação de cancelamento.
   * @return cancelAmount
  **/
  @ApiModelProperty(example = "19990", value = "Valor da solicitação de cancelamento.")
  ...
  public CancelQueryResponse statusProcessingCancelCode(String statusProcessingCancelCode) {
    this.statusProcessingCancelCode = statusProcessingCancelCode;
    return this;
  }

   /**
   * Código do status da solicitação de cancelamento.
   * @return statusProcessingCancelCode
  **/
  @ApiModelProperty(example = "100", value = "Código do status da solicitação de cancelamento.")
  public String getStatusProcessingCancelCode() {
    return statusProcessingCancelCode;
  }

  public void setStatusProcessingCancelCode(String statusProcessingCancelCode) {
    this.statusProcessingCancelCode = statusProcessingCancelCode;
  }

  public CancelQueryResponse statusProcessingCancelMessage(String statusProcessingCancelMessage) {
    this.statusProcessingCancelMessage = statusProcessingCancelMessage;
    return this;
  }

   /**
   * Mensagem do status da solicitação de cancelamento.
   * @return statusProcessingCancelMessage
  **/
  @ApiModelProperty(example = "SOLICITACAO EM ANDAMENTO", value = "Mensagem do status da solicitação de cancelamento.")
  public String getStatusProcessingCancelMessage() {
    return statusProcessingCancelMessage;
  }

  public void setStatusProcessingCancelMessage(String statusProcessingCancelMessage) {
    this.statusProcessingCancelMessage = statusProcessingCancelMessage;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.sellerId, cancelQueryResponse.sellerId) &&
        Objects.equals(this.paymentId, cancelQueryResponse.paymentId) &&
        Objects.equals(this.cancelRequestAt, cancelQueryResponse.cancelRequestAt) &&
        Objects.equals(this.cancelRequestId, cancelQueryResponse.cancelRequestId) &&
        Objects.equals(this.cancelCustomKey, cancelQueryResponse.cancelCustomKey) &&
        Objects.equals(this.terminalNsu, cancelQueryResponse.terminalNsu) &&
        Objects.equals(this.acquirerTransactionId, cancelQueryResponse.acquirerTransactionId) &&
        Objects.equals(this.transactionDate, cancelQueryResponse.transactionDate) &&
        Objects.equals(this.currency, cancelQueryResponse.currency) &&
        Objects.equals(this.transactionType, cancelQueryResponse.transactionType) &&
        Objects.equals(this.numberInstallments, cancelQueryResponse.numberInstallments) &&
        Objects.equals(this.amount, cancelQueryResponse.amount) &&
        Objects.equals(this.cancelAmount, cancelQueryResponse.cancelAmount) &&
        Objects.equals(this.statusProcessingCancelCode, cancelQueryResponse.statusProcessingCancelCode) &&
        Objects.equals(this.statusProcessingCancelMessage, cancelQueryResponse.statusProcessingCancelMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sellerId, paymentId, cancelRequestAt, cancelRequestId, cancelCustomKey, terminalNsu, acquirerTransactionId, transactionDate, currency, transactionType, numberInstallments, amount, cancelAmount, statusProcessingCancelCode, statusProcessingCancelMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("    statusProcessingCancelCode: ").append(toIndentedString(statusProcessingCancelCode)).append("\n");
    sb.append("    statusProcessingCancelMessage: ").append(toIndentedString(statusProcessingCancelMessage)).append("\n");
    sb.append("}");
    return sb.toString();
  }
