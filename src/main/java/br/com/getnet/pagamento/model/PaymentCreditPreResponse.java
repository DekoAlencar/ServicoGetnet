...
import br.com.getnet.pagamento.model.PaymentCreditDetail;
import java.io.IOException;

/**
 * Conjunto de dados da resposta do pagamento de crédito.
 */
@ApiModel(description = "Conjunto de dados da resposta do pagamento de crédito.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-01-25T16:02:55.559Z")
public class PaymentCreditPreResponse {
  ...
  private PaymentCreditDetail credit = null;

  public PaymentCreditPreResponse paymentId(String paymentId) {
  ...
  **/
  ...
  public PaymentCreditPreResponse sellerId(String sellerId) {
  ...
  **/
  ...
  public PaymentCreditPreResponse amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public PaymentCreditPreResponse currency(String currency) {
  ...
  **/
  ...
  public PaymentCreditPreResponse orderId(String orderId) {
  ...
  **/
  ...
  public PaymentCreditPreResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
  **/
  @ApiModelProperty(example = "AUTHORIZED", value = "Status da transação. Para mais informações sobre os status de retorno, veja o FAQ:\"https://developers.getnet.com.br/faq\"")
  ...
  public PaymentCreditPreResponse receivedAt(String receivedAt) {
  ...
  **/
  ...
  public PaymentCreditPreResponse credit(PaymentCreditDetail credit) {
    this.credit = credit;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentCreditPreResponse paymentCreditPreResponse = (PaymentCreditPreResponse) o;
    return Objects.equals(this.paymentId, paymentCreditPreResponse.paymentId) &&
        Objects.equals(this.sellerId, paymentCreditPreResponse.sellerId) &&
        Objects.equals(this.amount, paymentCreditPreResponse.amount) &&
        Objects.equals(this.currency, paymentCreditPreResponse.currency) &&
        Objects.equals(this.orderId, paymentCreditPreResponse.orderId) &&
        Objects.equals(this.status, paymentCreditPreResponse.status) &&
        Objects.equals(this.receivedAt, paymentCreditPreResponse.receivedAt) &&
        Objects.equals(this.credit, paymentCreditPreResponse.credit);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentCreditPreResponse {\n");
