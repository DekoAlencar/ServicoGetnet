...
public class Customer {
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(example = "João da Silva", value = "Nome completo do comprador. Obrigatório para boleto.")
  ...
  **/
  ...
  public Customer documentType(DocumentTypeEnum documentType) {
   ...
   * @return documentType
  **/
  @ApiModelProperty(example = "CPF", value = "Tipo do documento de identificação do comprador. Obrigatório para boleto.")
  ...
  **/
  @ApiModelProperty(example = "12345678912", value = "Número do documento do comprador sem pontuação. (sem máscara)")
   ...
   * @return phoneNumber
  **/
  @ApiModelProperty(example = "5551999887766", value = "Telefone do comprador. (sem máscara)")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(customerId, firstName, lastName, name, email, documentType, documentNumber, phoneNumber, billingAddress);
  }
