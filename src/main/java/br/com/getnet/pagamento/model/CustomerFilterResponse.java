...
import br.com.getnet.pagamento.model.CustomerFilterInfoResponse;
...
public class CustomerFilterResponse {
  ...
  private List<CustomerFilterInfoResponse> customers = null;
  ...
  public CustomerFilterResponse customers(List<CustomerFilterInfoResponse> customers) {
    this.customers = customers;
    return this;
  }

  public CustomerFilterResponse addCustomersItem(CustomerFilterInfoResponse customersItem) {
    if (this.customers == null) {
      this.customers = new ArrayList<CustomerFilterInfoResponse>();
    }
  ...
  **/
  ...
  public List<CustomerFilterInfoResponse> getCustomers() {
    return customers;
  }

  public void setCustomers(List<CustomerFilterInfoResponse> customers) {
    this.customers = customers;
  }

  public CustomerFilterResponse page(BigDecimal page) {
    this.page = page;
    return this;
  }
   ...
   * @return page
  **/
  @ApiModelProperty(example = "1.0", required = true, value = "Página corrente.")
  ...
  public CustomerFilterResponse limit(BigDecimal limit) {
    this.limit = limit;
    return this;
  }
   ...
   * @return limit
  **/
  @ApiModelProperty(example = "10.0", required = true, value = "Número de registros por página.")
  ...
  public CustomerFilterResponse total(BigDecimal total) {
    this.total = total;
    return this;
  }
   ...
   * @return total
  **/
  @ApiModelProperty(example = "1.0", required = true, value = "Total de clientes cadastrados.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CustomerFilterResponse customerFilterResponse = (CustomerFilterResponse) o;
    return Objects.equals(this.customers, customerFilterResponse.customers) &&
        Objects.equals(this.page, customerFilterResponse.page) &&
        Objects.equals(this.limit, customerFilterResponse.limit) &&
        Objects.equals(this.total, customerFilterResponse.total);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customers, page, limit, total);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomerFilterResponse {\n");
