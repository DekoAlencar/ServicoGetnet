...
public class Address {
   ...
   * @return street
  **/
  @ApiModelProperty(example = "Av. Brasil", value = "Logradouro.")
   ...
   * @return number
  **/
  @ApiModelProperty(example = "1000", value = "Número do logradouro.")
  ...
  **/
   ...
   * @return district
  **/
  @ApiModelProperty(example = "São Geraldo", value = "Bairro.")
   ...
   * @return city
  **/
  @ApiModelProperty(example = "Porto Alegre", value = "Cidade.")
   ...
   * @return state
  **/
  @ApiModelProperty(example = "RS", value = "Estado (UF).")
   ...
   * @return country
  **/
  @ApiModelProperty(example = "Brasil", value = "País.")
   ...
   * @return postalCode
  **/
  @ApiModelProperty(example = "90230060", value = "Código Postal, CEP no Brasil ou ZIP nos Estados Unidos. (sem máscara)")
