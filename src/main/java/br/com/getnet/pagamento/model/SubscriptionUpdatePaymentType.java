...
public class SubscriptionUpdatePaymentType {
  ...
  /**
   * Bandeira. (Utilizado também no antifraude). Obrigatório caso os dados de cartão não foram armazenados permanentemente com o token.
   */
  ...
  public SubscriptionUpdatePaymentType numberToken(String numberToken) {
   ...
   * @return numberToken
  **/
  @ApiModelProperty(example = "dfe05208b105578c070f806c80abd3af09e246827d29b866cf4ce16c205849977c9496cbf0d0234f42339937f327747075f68763537b90b31389e01231d4d13c", value = "Número do cartão tokenizado.")
  ...
  public SubscriptionUpdatePaymentType cardholderName(String cardholderName) {
    this.cardholderName = cardholderName;
    return this;
  }

   /**
   * Nome do comprador impresso no cartão. Obrigatório caso os dados de cartão não foram armazenados permanentemente com o token.
   * @return cardholderName
  **/
  @ApiModelProperty(example = "JOAO DA SILVA", value = "Nome do comprador impresso no cartão. Obrigatório caso os dados de cartão não foram armazenados permanentemente com o token.")
  ...
  public SubscriptionUpdatePaymentType brand(BrandEnum brand) {
    this.brand = brand;
    return this;
  }
   ...
   * @return brand
  **/
  @ApiModelProperty(example = "Mastercard", value = "Bandeira. (Utilizado também no antifraude). Obrigatório caso os dados de cartão não foram armazenados permanentemente com o token.")
  ...
  public SubscriptionUpdatePaymentType expirationMonth(String expirationMonth) {
    this.expirationMonth = expirationMonth;
    return this;
  }

   /**
   * Mês de expiração do cartão com dois dígitos. Obrigatório caso os dados de cartão não foram armazenados permanentemente com o token.
   * @return expirationMonth
  **/
  @ApiModelProperty(example = "12", value = "Mês de expiração do cartão com dois dígitos. Obrigatório caso os dados de cartão não foram armazenados permanentemente com o token.")
  ...
  public SubscriptionUpdatePaymentType expirationYear(String expirationYear) {
    this.expirationYear = expirationYear;
    return this;
  }

   /**
   * Ano de expiração do cartão com dois dígitos. Obrigatório caso os dados de cartão não foram armazenados permanentemente com o token.
   * @return expirationYear
  **/
  @ApiModelProperty(example = "20", value = "Ano de expiração do cartão com dois dígitos. Obrigatório caso os dados de cartão não foram armazenados permanentemente com o token.")
  ...
  public SubscriptionUpdatePaymentType bin(String bin) {
    this.bin = bin;
    return this;
  }
   ...
   * @return bin
  **/
  @ApiModelProperty(example = "123412", value = "Seis primeiros números do cartão.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SubscriptionUpdatePaymentType subscriptionUpdatePaymentType = (SubscriptionUpdatePaymentType) o;
    return Objects.equals(this.numberToken, subscriptionUpdatePaymentType.numberToken) &&
        Objects.equals(this.cardholderName, subscriptionUpdatePaymentType.cardholderName) &&
        Objects.equals(this.brand, subscriptionUpdatePaymentType.brand) &&
        Objects.equals(this.expirationMonth, subscriptionUpdatePaymentType.expirationMonth) &&
        Objects.equals(this.expirationYear, subscriptionUpdatePaymentType.expirationYear) &&
        Objects.equals(this.bin, subscriptionUpdatePaymentType.bin);
  }

  @Override
  public int hashCode() {
    return Objects.hash(numberToken, cardholderName, brand, expirationMonth, expirationYear, bin);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubscriptionUpdatePaymentType {\n");
