...
public class Credit {
   ...
   * @return delayed
  **/
  @ApiModelProperty(example = "false", required = true, value = "Identifica se o crédito será feito com confirmação tardia.")
  ...
  public Credit authenticated(Boolean authenticated) {
  ...
  **/
  @ApiModelProperty(example = "false", value = "Indicativo se transação deve ter o processo de autenticação no emissor, caso authenticated = true, o portador deve ser encaminhado ao site do emissor para autenticação junto ao mesmo.")
  ...
  **/
  @ApiModelProperty(example = "false", value = "Indicativo se a transação é uma pré autorização de crédito.")
   ...
   * @return saveCardData
  **/
  @ApiModelProperty(example = "false", required = true, value = "Identifica se o cartão deve ser salvo para futuras compras.")
  ...
  **/
  @ApiModelProperty(example = "1.0", required = true, value = "Número de parcelas para uma transação de crédito parcelado.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.delayed, credit.delayed) &&
        Objects.equals(this.authenticated, credit.authenticated) &&
        ...
        Objects.equals(this.dynamicMcc, credit.dynamicMcc) &&
        Objects.equals(this.card, credit.card);
  }

  @Override
  public int hashCode() {
    return Objects.hash(delayed, authenticated, preAuthorization, saveCardData, transactionType, numberInstallments, softDescriptor, dynamicMcc, card);
  }
