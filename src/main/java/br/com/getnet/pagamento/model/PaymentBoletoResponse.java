...
import br.com.getnet.pagamento.model.PaymentBoletoDetail;
import java.io.IOException;

/**
 * Conjunto de dados da responda da emissão do boleto.
 */
@ApiModel(description = "Conjunto de dados da responda da emissão do boleto.")
...
public class PaymentBoletoResponse {
  ...
  private PaymentBoletoDetail boleto = null;

  public PaymentBoletoResponse paymentId(String paymentId) {
   ...
   * @return paymentId
  **/
  @ApiModelProperty(example = "599ca35059028b001023b323", value = "Código de identificação do pagamento.")
  ...
  public PaymentBoletoResponse sellerId(String sellerId) {
  ...
  **/
  ...
  public PaymentBoletoResponse amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public PaymentBoletoResponse currency(String currency) {
  ...
  **/
  ...
  public PaymentBoletoResponse orderId(String orderId) {
  ...
  **/
  ...
  public PaymentBoletoResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
  **/
  @ApiModelProperty(example = "PENDING", value = "Status da transação. Para mais informações sobre os status de retorno, veja o FAQ:\"https://developers.getnet.com.br/faq\"")
  ...
  public PaymentBoletoResponse boleto(PaymentBoletoDetail boleto) {
    this.boleto = boleto;
    return this;
  }
  ...
  **/
  ...
  public PaymentBoletoDetail getBoleto() {
    return boleto;
  }

  public void setBoleto(PaymentBoletoDetail boleto) {
    this.boleto = boleto;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentBoletoResponse paymentBoletoResponse = (PaymentBoletoResponse) o;
    return Objects.equals(this.paymentId, paymentBoletoResponse.paymentId) &&
        Objects.equals(this.sellerId, paymentBoletoResponse.sellerId) &&
        Objects.equals(this.amount, paymentBoletoResponse.amount) &&
        Objects.equals(this.currency, paymentBoletoResponse.currency) &&
        Objects.equals(this.orderId, paymentBoletoResponse.orderId) &&
        Objects.equals(this.status, paymentBoletoResponse.status) &&
        Objects.equals(this.boleto, paymentBoletoResponse.boleto);
  }

  @Override
  public int hashCode() {
    return Objects.hash(paymentId, sellerId, amount, currency, orderId, status, boleto);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentBoletoResponse {\n");
