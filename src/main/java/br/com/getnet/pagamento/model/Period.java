 ...
 * Período do plano.
 */
@ApiModel(description = "Período do plano.")
...
public class Period {
  ...
  private Integer billingCycle = null;

  @SerializedName("specific_cycle_in_days")
  private BigDecimal specificCycleInDays = null;
   ...
   * @return type
  **/
  @ApiModelProperty(example = "monthly", required = true, value = "Tipo de periodicidade.")
  ...
  public Period billingCycle(Integer billingCycle) {
    this.billingCycle = billingCycle;
    return this;
  }

   /**
   * Duração do plano com base no tipo de periodicidade. Por exemplo, para um plano de 12 meses, onde a cobrança será realizada mensalmente (type &#x3D; monthly) o valor a ser atribuído é 12.
   * minimum: 0
   * @return billingCycle
  **/
  @ApiModelProperty(example = "12", required = true, value = "Duração do plano com base no tipo de periodicidade. Por exemplo, para um plano de 12 meses, onde a cobrança será realizada mensalmente (type = monthly) o valor a ser atribuído é 12.")
  ...
  public Period specificCycleInDays(BigDecimal specificCycleInDays) {
    this.specificCycleInDays = specificCycleInDays;
    return this;
  }

   /**
   * Ciclo específico de cobrança em dias. Quando o tipo de periodicidade for específico (type &#x3D; specific) deve ser atribuído o número de dias em que o ciclo de cobrança será realizado. Por exemplo, se a duração do plano for 12 (billing_cycle &#x3D; 12) e o ciclo específico for 10 (specific_cycle_in_days &#x3D; 10), significa que a cobrança ocorrerá de 10 em 10 dias num todal de 12 cobranças.
   * @return specificCycleInDays
  **/
  @ApiModelProperty(value = "Ciclo específico de cobrança em dias. Quando o tipo de periodicidade for específico (type = specific) deve ser atribuído o número de dias em que o ciclo de cobrança será realizado. Por exemplo, se a duração do plano for 12 (billing_cycle = 12) e o ciclo específico for 10 (specific_cycle_in_days = 10), significa que a cobrança ocorrerá de 10 em 10 dias num todal de 12 cobranças.")
  public BigDecimal getSpecificCycleInDays() {
    return specificCycleInDays;
  }

  public void setSpecificCycleInDays(BigDecimal specificCycleInDays) {
    this.specificCycleInDays = specificCycleInDays;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.type, period.type) &&
        Objects.equals(this.billingCycle, period.billingCycle) &&
        Objects.equals(this.specificCycleInDays, period.specificCycleInDays);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, billingCycle, specificCycleInDays);
  }
  ...
  public String toString() {
    ...
    sb.append("    specificCycleInDays: ").append(toIndentedString(specificCycleInDays)).append("\n");
    sb.append("}");
    return sb.toString();
  }
