...
public class PaymentCreditDetail {
   ...
   * @return delayed
  **/
  @ApiModelProperty(example = "false", value = "Identifica se o crédito será feito com confirmação tardia.")
  ...
  **/
  ...
  public PaymentCreditDetail brand(BrandEnum brand) {
    this.brand = brand;
    return this;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(delayed, authorizationCode, authorizedAt, reasonCode, reasonMessage, acquirer, softDescriptor, brand, terminalNsu, acquirerTransactionId);
  }
