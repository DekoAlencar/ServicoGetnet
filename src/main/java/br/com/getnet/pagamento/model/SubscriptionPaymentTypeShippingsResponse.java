...
import br.com.getnet.pagamento.model.SubscriptionPaymentTypeCreditResponse;
import br.com.getnet.pagamento.model.SubscriptionShippings;
 ...
 */
@ApiModel(description = "Informações da assinatura.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-01-25T16:02:55.559Z")
public class SubscriptionPaymentTypeShippingsResponse {
  @SerializedName("subscription_id")
  private String subscriptionId = null;

  @SerializedName("payment_type")
  private SubscriptionPaymentTypeCreditResponse paymentType = null;

  @SerializedName("shippings")
  private List<SubscriptionShippings> shippings = null;

  public SubscriptionPaymentTypeShippingsResponse subscriptionId(String subscriptionId) {
    this.subscriptionId = subscriptionId;
    return this;
  }

   /**
   * Identificador da assinatura de recorrência.
   * @return subscriptionId
  **/
  @ApiModelProperty(example = "5d740ea0-b7d1-42f5-ad64-5a5521e12er9", value = "Identificador da assinatura de recorrência.")
  ...
  public SubscriptionPaymentTypeShippingsResponse paymentType(SubscriptionPaymentTypeCreditResponse paymentType) {
  ...
  **/
  ...
  public SubscriptionPaymentTypeCreditResponse getPaymentType() {
    return paymentType;
  }

  public void setPaymentType(SubscriptionPaymentTypeCreditResponse paymentType) {
    this.paymentType = paymentType;
  }

  public SubscriptionPaymentTypeShippingsResponse shippings(List<SubscriptionShippings> shippings) {
    this.shippings = shippings;
    return this;
  }

  public SubscriptionPaymentTypeShippingsResponse addShippingsItem(SubscriptionShippings shippingsItem) {
    if (this.shippings == null) {
      this.shippings = new ArrayList<SubscriptionShippings>();
    }
   ...
   /**
   * Conjunto de endereços de entrega.
   * @return shippings
  **/
  @ApiModelProperty(value = "Conjunto de endereços de entrega.")
  public List<SubscriptionShippings> getShippings() {
    return shippings;
  }

  public void setShippings(List<SubscriptionShippings> shippings) {
    this.shippings = shippings;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SubscriptionPaymentTypeShippingsResponse subscriptionPaymentTypeShippingsResponse = (SubscriptionPaymentTypeShippingsResponse) o;
    return Objects.equals(this.subscriptionId, subscriptionPaymentTypeShippingsResponse.subscriptionId) &&
        Objects.equals(this.paymentType, subscriptionPaymentTypeShippingsResponse.paymentType) &&
        Objects.equals(this.shippings, subscriptionPaymentTypeShippingsResponse.shippings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subscriptionId, paymentType, shippings);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubscriptionPaymentTypeShippingsResponse {\n");
