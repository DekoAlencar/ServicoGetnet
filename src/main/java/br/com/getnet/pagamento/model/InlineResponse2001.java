...
public class InlineResponse2001 {
  /**
   * Status da verificação do cartão, onde VERIFIED é o indicativo de que o cartão foi validado com sucesso.
   */
   ...
   * @return status
  **/
  @ApiModelProperty(example = "VERIFIED", value = "Status da verificação do cartão, onde VERIFIED é o indicativo de que o cartão foi validado com sucesso.")
  ...
  public InlineResponse2001 verificationId(String verificationId) {
  ...
  **/
  @ApiModelProperty(example = "ae267804-503c-4163-b1b1-f5da5120b74e", value = "Identificação do pedido de verificação na plataforma digital.")
  ...
  public InlineResponse2001 authorizationCode(String authorizationCode) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.status, inlineResponse2001.status) &&
        Objects.equals(this.verificationId, inlineResponse2001.verificationId) &&
        Objects.equals(this.authorizationCode, inlineResponse2001.authorizationCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, verificationId, authorizationCode);
  }
