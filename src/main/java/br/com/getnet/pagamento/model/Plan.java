...
public class Plan {
  ...
  public Plan sellerId(String sellerId) {
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(example = "Plano flex", required = true, value = "Nome do plano.")
  ...
  **/
   ...
   * @return amount
  **/
  @ApiModelProperty(example = "19990", required = true, value = "Valor do plano.")
  ...
  public Plan currency(String currency) {
   ...
   /**
   * Identificação da moeda (Consultar código em \&quot;https://en.wikipedia.org/wiki/ISO_4217\&quot;).
   * @return currency
  **/
  @ApiModelProperty(example = "BRL", required = true, value = "Identificação da moeda (Consultar código em \"https://en.wikipedia.org/wiki/ISO_4217\").")
  ...
  public Plan paymentTypes(List<String> paymentTypes) {
    this.paymentTypes = paymentTypes;
    return this;
  }

  public Plan addPaymentTypesItem(String paymentTypesItem) {
   ...
   * @return paymentTypes
  **/
  @ApiModelProperty(example = "[\"credit_card\"]", required = true, value = "Tipos de pagamentos aceitos.")
  ...
  public Plan salesTax(Integer salesTax) {
  ...
  **/
  ...
  public Plan productType(ProductTypeEnum productType) {
  ...
  **/
  ...
  public Plan period(Period period) {
    this.period = period;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Plan plan = (Plan) o;
    return Objects.equals(this.sellerId, plan.sellerId) &&
        ...
        Objects.equals(this.paymentTypes, plan.paymentTypes) &&
        Objects.equals(this.salesTax, plan.salesTax) &&
        Objects.equals(this.productType, plan.productType) &&
        Objects.equals(this.period, plan.period);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sellerId, name, description, amount, currency, paymentTypes, salesTax, productType, period);
  }
