...
import br.com.getnet.pagamento.model.SubscriptionPaymentTypeShippings;
...
public class Subscription {
  ...
  private SubscriptionPaymentTypeShippings subscription = null;

  @SerializedName("device")
  private Device device = null;

  public Subscription sellerId(String sellerId) {
  ...
  **/
   ...
   * @return customerId
  **/
  @ApiModelProperty(example = "customer_21081826", required = true, value = "Identificador do comprador.")
  ...
  public Subscription planId(String planId) {
   ...
   /**
   * Identificador do plano de recorrência.
   * @return planId
  **/
  @ApiModelProperty(example = "51995e24-b1ae-4826-8e15-2a568a87abdd", required = true, value = "Identificador do plano de recorrência.")
  ...
  public Subscription orderId(String orderId) {
  ...
  **/
  ...
  public Subscription subscription(SubscriptionPaymentTypeShippings subscription) {
  ...
  **/
  ...
  public SubscriptionPaymentTypeShippings getSubscription() {
    return subscription;
  }

  public void setSubscription(SubscriptionPaymentTypeShippings subscription) {
    this.subscription = subscription;
  }

  public Subscription device(Device device) {
    this.device = device;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.sellerId, subscription.sellerId) &&
        Objects.equals(this.customerId, subscription.customerId) &&
        Objects.equals(this.planId, subscription.planId) &&
        Objects.equals(this.orderId, subscription.orderId) &&
        Objects.equals(this.subscription, subscription.subscription) &&
        Objects.equals(this.device, subscription.device);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sellerId, customerId, planId, orderId, subscription, device);
  }
