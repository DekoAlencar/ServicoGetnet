...
import br.com.getnet.pagamento.model.PaymentCreditCancelDetails;
import java.io.IOException;

/**
 * Conjunto de dados da resposta do cancelamento de pagamento de crédito completo ou com confirmação tardia.
 */
@ApiModel(description = "Conjunto de dados da resposta do cancelamento de pagamento de crédito completo ou com confirmação tardia.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-01-25T16:02:55.559Z")
public class CreditDelayedCancel {
  ...
  public CreditDelayedCancel paymentId(String paymentId) {
   ...
   * @return paymentId
  **/
  @ApiModelProperty(example = "f3b54da1-0753-4dcf-ac92-48721d2ff553", value = "Código de identificação do pagamento.")
  ...
  public CreditDelayedCancel sellerId(String sellerId) {
   ...
   * @return sellerId
  **/
  @ApiModelProperty(example = "8f840ea0-b7d1-42f5-ad78-5a5521e3125f", value = "Código de identificação do e-commerce.")
  ...
  public CreditDelayedCancel amount(Integer amount) {
    this.amount = amount;
    return this;
  }
   ...
   * @return amount
  **/
  @ApiModelProperty(example = "500000", value = "Valor da compra em centavos.")
  ...
  public CreditDelayedCancel currency(String currency) {
  ...
  **/
  ...
  public CreditDelayedCancel orderId(String orderId) {
   ...
   * @return orderId
  **/
  @ApiModelProperty(example = "pre-auth-order-204", value = "Código de identificação da compra utilizado pelo e-commerce")
  ...
  public CreditDelayedCancel status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
  **/
  @ApiModelProperty(example = "CANCELED", value = "Status da transação. Para mais informações sobre os status de retorno, veja o FAQ:\"https://developers.getnet.com.br/faq\"")
  ...
  public CreditDelayedCancel creditCancel(PaymentCreditCancelDetails creditCancel) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreditDelayedCancel creditDelayedCancel = (CreditDelayedCancel) o;
