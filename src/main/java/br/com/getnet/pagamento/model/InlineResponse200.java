...
public class InlineResponse200 {
   ...
   * @return accessToken
  **/
  @ApiModelProperty(example = "ca22a2ge-1914-4b0c-a0fb-d3ce0fde7346", value = "Token de acesso a API para envio em todas as requisições")
  ...
  public InlineResponse200 tokenType(String tokenType) {
   ...
   /**
   * Tipo do token, deve ser enviado no header junto do token (https://tools.ietf.org/html/rfc6750)
   * @return tokenType
  **/
  @ApiModelProperty(example = "Bearer", value = "Tipo do token, deve ser enviado no header junto do token (https://tools.ietf.org/html/rfc6750)")
  ...
  public InlineResponse200 expiresIn(BigDecimal expiresIn) {
   ...
   * @return expiresIn
  **/
  @ApiModelProperty(example = "3600.0", value = "Tempo de expiração do token em segundos")
   ...
   * @return scope
  **/
  @ApiModelProperty(example = "oob", value = "Escopo do token")
