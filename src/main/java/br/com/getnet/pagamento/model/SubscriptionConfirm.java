...
public class SubscriptionConfirm {
  ...
  public SubscriptionConfirm sellerId(String sellerId) {
  ...
  **/
  ...
  public SubscriptionConfirm statusDetails(String statusDetails) {
  ...
  **/
  @ApiModelProperty(example = "Pagamento de assinatura confirmado", required = true, value = "Detalhes do status da assinatura de recorrência.")
  ...
  public SubscriptionConfirm chargeId(String chargeId) {
   ...
   * @return chargeId
  **/
  @ApiModelProperty(example = "52bc81b2-f079-4f7b-b63a-f653ff29d794", required = true, value = "Identificador da cobrança.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SubscriptionConfirm subscriptionConfirm = (SubscriptionConfirm) o;
    return Objects.equals(this.sellerId, subscriptionConfirm.sellerId) &&
        Objects.equals(this.statusDetails, subscriptionConfirm.statusDetails) &&
        Objects.equals(this.chargeId, subscriptionConfirm.chargeId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sellerId, statusDetails, chargeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubscriptionConfirm {\n");
