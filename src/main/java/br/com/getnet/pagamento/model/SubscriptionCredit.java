...
import br.com.getnet.pagamento.model.SubscriptionCard;
...
public class SubscriptionCredit {
  ...
  @SerializedName("card")
  private SubscriptionCard card = null;

  public SubscriptionCredit transactionType(TransactionTypeEnum transactionType) {
  ...
  **/
  @ApiModelProperty(example = "FULL", required = true, value = "Tipo de transação. Pagamento completo à vista, parcelado sem juros, parcelado com juros.")
  ...
  public SubscriptionCredit numberInstallments(Integer numberInstallments) {
  ...
  **/
  @ApiModelProperty(example = "1", required = true, value = "Número de parcelas para uma transação de crédito parcelado.")
  ...
  public SubscriptionCredit softDescriptor(String softDescriptor) {
  ...
  **/
  ...
  public SubscriptionCredit billingAddress(Address billingAddress) {
  ...
  **/
  ...
  public SubscriptionCredit card(SubscriptionCard card) {
    this.card = card;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SubscriptionCredit subscriptionCredit = (SubscriptionCredit) o;
    return Objects.equals(this.transactionType, subscriptionCredit.transactionType) &&
        Objects.equals(this.numberInstallments, subscriptionCredit.numberInstallments) &&
        Objects.equals(this.softDescriptor, subscriptionCredit.softDescriptor) &&
        Objects.equals(this.billingAddress, subscriptionCredit.billingAddress) &&
        Objects.equals(this.card, subscriptionCredit.card);
  }

  @Override
  public int hashCode() {
    return Objects.hash(transactionType, numberInstallments, softDescriptor, billingAddress, card);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubscriptionCredit {\n");
