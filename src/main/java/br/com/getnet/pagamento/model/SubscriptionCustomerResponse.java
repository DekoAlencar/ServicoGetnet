...
/**
 * Conjunto de dados do comprador.
 */
@ApiModel(description = "Conjunto de dados do comprador.")
...
public class SubscriptionCustomerResponse {
  ...
  @SerializedName("celphone_number")
  private String celphoneNumber = null;
  ...
  public SubscriptionCustomerResponse customerId(String customerId) {
  ...
  **/
  ...
  public SubscriptionCustomerResponse firstName(String firstName) {
  ...
  **/
  ...
  public SubscriptionCustomerResponse lastName(String lastName) {
  ...
  **/
  ...
  public SubscriptionCustomerResponse documentType(DocumentTypeEnum documentType) {
   ...
   * @return documentType
  **/
  @ApiModelProperty(example = "CPF", value = "Tipo de documento do comprador.")
  ...
  public SubscriptionCustomerResponse documentNumber(String documentNumber) {
    this.documentNumber = documentNumber;
    return this;
  }

   /**
   * Número do documento do comprador. (sem máscara)
   * @return documentNumber
  **/
  @ApiModelProperty(example = "12345678912", value = "Número do documento do comprador. (sem máscara)")
  ...
  public SubscriptionCustomerResponse birthDate(String birthDate) {
   ...
   * @return birthDate
  **/
  @ApiModelProperty(example = "1976-02-21", value = "Data de nascimento do comprador.")
  ...
  public SubscriptionCustomerResponse phoneNumber(String phoneNumber) {
    this.phoneNumber = phoneNumber;
    return this;
  }

   /**
   * Número do telefone do comprador. (sem máscara)
   * @return phoneNumber
  **/
  @ApiModelProperty(example = "5551999887766", value = "Número do telefone do comprador. (sem máscara)")
  ...
  public SubscriptionCustomerResponse celphoneNumber(String celphoneNumber) {
    this.celphoneNumber = celphoneNumber;
    return this;
  }

   /**
   * Número do telefone celular do comprador. (sem máscara)
   * @return celphoneNumber
  **/
  @ApiModelProperty(example = "5551999887766", value = "Número do telefone celular do comprador. (sem máscara)")
  ...
  public SubscriptionCustomerResponse email(String email) {
    this.email = email;
    return this;
  }
   ...
   * @return email
  **/
  @ApiModelProperty(example = "customer@email.com.br", value = "Email do comprador.")
  ...
  public SubscriptionCustomerResponse observation(String observation) {
   ...
   * @return observation
  **/
  @ApiModelProperty(example = "O cliente tem interesse no plano x.", value = "Observações.")
  ...
  public SubscriptionCustomerResponse address(Address address) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.customerId, subscriptionCustomerResponse.customerId) &&
        Objects.equals(this.firstName, subscriptionCustomerResponse.firstName) &&
        Objects.equals(this.lastName, subscriptionCustomerResponse.lastName) &&
        Objects.equals(this.documentType, subscriptionCustomerResponse.documentType) &&
        Objects.equals(this.documentNumber, subscriptionCustomerResponse.documentNumber) &&
        Objects.equals(this.birthDate, subscriptionCustomerResponse.birthDate) &&
        Objects.equals(this.phoneNumber, subscriptionCustomerResponse.phoneNumber) &&
        Objects.equals(this.celphoneNumber, subscriptionCustomerResponse.celphoneNumber) &&
        Objects.equals(this.email, subscriptionCustomerResponse.email) &&
        Objects.equals(this.observation, subscriptionCustomerResponse.observation) &&
        Objects.equals(this.address, subscriptionCustomerResponse.address);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customerId, firstName, lastName, documentType, documentNumber, birthDate, phoneNumber, celphoneNumber, email, observation, address);
  }
  ...
  public String toString() {
    ...
    sb.append("    celphoneNumber: ").append(toIndentedString(celphoneNumber)).append("\n");
