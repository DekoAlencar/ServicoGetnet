...
import br.com.getnet.pagamento.model.PostData;
import java.io.IOException;

/**
 * Conjunto de dados da resposta do pagamento autenticado crédito ou débito.
 */
@ApiModel(description = "Conjunto de dados da resposta do pagamento autenticado crédito ou débito.")
...
public class PaymentAuthenticatedResponse {
  ...
  public PaymentAuthenticatedResponse paymentId(String paymentId) {
  ...
  **/
  ...
  public PaymentAuthenticatedResponse sellerId(String sellerId) {
  ...
  **/
  ...
  public PaymentAuthenticatedResponse redirectUrl(String redirectUrl) {
    this.redirectUrl = redirectUrl;
    return this;
  }

   /**
   * URL do emissor para redirecionamento do fluxo de pagamento e processamento da autenticação.
   * @return redirectUrl
  **/
  @ApiModelProperty(example = "https://url.emissor.com/lkasdufou90", value = "URL do emissor para redirecionamento do fluxo de pagamento e processamento da autenticação.")
  ...
  public PaymentAuthenticatedResponse postData(PostData postData) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentAuthenticatedResponse paymentAuthenticatedResponse = (PaymentAuthenticatedResponse) o;
    return Objects.equals(this.paymentId, paymentAuthenticatedResponse.paymentId) &&
        Objects.equals(this.sellerId, paymentAuthenticatedResponse.sellerId) &&
        Objects.equals(this.redirectUrl, paymentAuthenticatedResponse.redirectUrl) &&
        Objects.equals(this.postData, paymentAuthenticatedResponse.postData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(paymentId, sellerId, redirectUrl, postData);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentAuthenticatedResponse {\n");
