...
import br.com.getnet.pagamento.model.ChargeFilter;
...
public class ChargeFilterResponse {
  @SerializedName("charges")
  private List<ChargeFilter> charges = null;
  ...
  public ChargeFilterResponse charges(List<ChargeFilter> charges) {
    this.charges = charges;
    return this;
  }

  public ChargeFilterResponse addChargesItem(ChargeFilter chargesItem) {
    if (this.charges == null) {
      this.charges = new ArrayList<ChargeFilter>();
    }
  ...
  **/
  ...
  public List<ChargeFilter> getCharges() {
    return charges;
  }

  public void setCharges(List<ChargeFilter> charges) {
    this.charges = charges;
  }

  public ChargeFilterResponse page(BigDecimal page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public ChargeFilterResponse limit(BigDecimal limit) {
    this.limit = limit;
    return this;
  }
  ...
  **/
  ...
  public ChargeFilterResponse total(BigDecimal total) {
    this.total = total;
    return this;
  }

   /**
   * Total de cobranças cadastradas.
   * @return total
  **/
  @ApiModelProperty(example = "1.0", required = true, value = "Total de cobranças cadastradas.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ChargeFilterResponse chargeFilterResponse = (ChargeFilterResponse) o;
    return Objects.equals(this.charges, chargeFilterResponse.charges) &&
        Objects.equals(this.page, chargeFilterResponse.page) &&
        Objects.equals(this.limit, chargeFilterResponse.limit) &&
        Objects.equals(this.total, chargeFilterResponse.total);
  }

  @Override
  public int hashCode() {
    return Objects.hash(charges, page, limit, total);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChargeFilterResponse {\n");
