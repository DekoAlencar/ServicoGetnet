...
public class CancelRequestResponse {
  ...
  /**
   * Status da transação aceita ou negada. Para mais informações sobre os status de retorno, veja o FAQ:\&quot;https://developers.getnet.com.br/faq\&quot;
   */
  ...
  **/
  ...
  public CancelRequestResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
  **/
  @ApiModelProperty(example = "ACCEPTED", value = "Status da transação aceita ou negada. Para mais informações sobre os status de retorno, veja o FAQ:\"https://developers.getnet.com.br/faq\"")
