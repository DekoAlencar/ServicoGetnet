...
/**
 * Conjunto de dados da resposta do ajuste de valor de Pré-Autorização.
 */
@ApiModel(description = "Conjunto de dados da resposta do ajuste de valor de Pré-Autorização.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-01-25T16:02:55.559Z")
public class CreditPreauthorizedAdjustmentResponse {
  ...
  /**
   * Status da transação. Para mais informações sobre os status de retorno, veja o FAQ:\&quot;https://developers.getnet.com.br/faq\&quot;
   */
  ...
  private BigDecimal authorizedAt = null;
  ...
  private BigDecimal acquirerTransactionId = null;

  @SerializedName("adjustment_acquirer_transaction_id")
  private BigDecimal adjustmentAcquirerTransactionId = null;

  public CreditPreauthorizedAdjustmentResponse paymentId(String paymentId) {
   ...
   * @return paymentId
  **/
  @ApiModelProperty(example = "06f256c8-1bbf-42bf-93b4-ce2041bfb87e", value = "Código de identificação do pagamento.")
  ...
  public CreditPreauthorizedAdjustmentResponse sellerId(String sellerId) {
  ...
  **/
  ...
  public CreditPreauthorizedAdjustmentResponse amount(Integer amount) {
    this.amount = amount;
    return this;
  }

   /**
   * Valor ajustado em centavos.
   * @return amount
  **/
  @ApiModelProperty(example = "19990", value = "Valor ajustado em centavos.")
  ...
  public CreditPreauthorizedAdjustmentResponse currency(String currency) {
   ...
   * @return currency
  **/
  @ApiModelProperty(example = "BRL", value = "Identificação da moeda (Consultar código em \"https://www.currency-iso.org/en/home/tables/table-a1.html\").")
  ...
  public CreditPreauthorizedAdjustmentResponse orderId(String orderId) {
   ...
   * @return orderId
  **/
  @ApiModelProperty(example = "6d2e4380-d8a3-4ccb-9138-c289182818a3", value = "Código de identificação da compra utilizado pelo e-commerce")
  ...
  public CreditPreauthorizedAdjustmentResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
  **/
  @ApiModelProperty(example = "APPROVED", value = "Status da transação. Para mais informações sobre os status de retorno, veja o FAQ:\"https://developers.getnet.com.br/faq\"")
  ...
  public CreditPreauthorizedAdjustmentResponse authorizationCode(String authorizationCode) {
    this.authorizationCode = authorizationCode;
    return this;
  }

   /**
   * Código da autorização de crédito
   * @return authorizationCode
  **/
  @ApiModelProperty(example = "000000099999", value = "Código da autorização de crédito")
  ...
  public CreditPreauthorizedAdjustmentResponse authorizedAt(BigDecimal authorizedAt) {
   ...
   * @return authorizedAt
  **/
  @ApiModelProperty(example = "2017-03-19T16:30:30Z", value = "Data/hora da autorização de crédito.")
  ...
  public CreditPreauthorizedAdjustmentResponse reasonCode(String reasonCode) {
   ...
   * @return reasonCode
  **/
  @ApiModelProperty(example = "0", value = "Código de retorno.")
  ...
  public CreditPreauthorizedAdjustmentResponse reasonMessage(String reasonMessage) {
  ...
  **/
  @ApiModelProperty(example = "transaction approved", value = "Mensagem de retorno.")
  ...
  public CreditPreauthorizedAdjustmentResponse acquirer(String acquirer) {
   ...
   * @return acquirer
  **/
  @ApiModelProperty(example = "GETNET", value = "Nome do adquirente.")
  ...
  public CreditPreauthorizedAdjustmentResponse softDescriptor(String softDescriptor) {
  ...
  **/
  @ApiModelProperty(example = "Descrição para fatura", value = "Descrição para a fatura do cartão.")
  ...
  public CreditPreauthorizedAdjustmentResponse terminalNsu(String terminalNsu) {
   ...
   * @return terminalNsu
  **/
  @ApiModelProperty(example = "0099999", value = "Código de Autorização gerado pelo Emissor quando a transação é realizada com sucesso.")
  ...
  public CreditPreauthorizedAdjustmentResponse acquirerTransactionId(BigDecimal acquirerTransactionId) {
  ...
  **/
  @ApiModelProperty(example = "1.60453221E8", value = "Código de transação do adquirente.")
  public BigDecimal getAcquirerTransactionId() {
    return acquirerTransactionId;
  }

  public void setAcquirerTransactionId(BigDecimal acquirerTransactionId) {
    this.acquirerTransactionId = acquirerTransactionId;
  }

  public CreditPreauthorizedAdjustmentResponse adjustmentAcquirerTransactionId(BigDecimal adjustmentAcquirerTransactionId) {
    this.adjustmentAcquirerTransactionId = adjustmentAcquirerTransactionId;
    return this;
  }

   /**
   * Código de transação de ajuste do adquirente.
   * @return adjustmentAcquirerTransactionId
  **/
  @ApiModelProperty(example = "1.60453231E8", value = "Código de transação de ajuste do adquirente.")
  public BigDecimal getAdjustmentAcquirerTransactionId() {
    return adjustmentAcquirerTransactionId;
  }

  public void setAdjustmentAcquirerTransactionId(BigDecimal adjustmentAcquirerTransactionId) {
    this.adjustmentAcquirerTransactionId = adjustmentAcquirerTransactionId;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreditPreauthorizedAdjustmentResponse creditPreauthorizedAdjustmentResponse = (CreditPreauthorizedAdjustmentResponse) o;
    return Objects.equals(this.paymentId, creditPreauthorizedAdjustmentResponse.paymentId) &&
        Objects.equals(this.sellerId, creditPreauthorizedAdjustmentResponse.sellerId) &&
        Objects.equals(this.amount, creditPreauthorizedAdjustmentResponse.amount) &&
        Objects.equals(this.currency, creditPreauthorizedAdjustmentResponse.currency) &&
        Objects.equals(this.orderId, creditPreauthorizedAdjustmentResponse.orderId) &&
        Objects.equals(this.status, creditPreauthorizedAdjustmentResponse.status) &&
        Objects.equals(this.authorizationCode, creditPreauthorizedAdjustmentResponse.authorizationCode) &&
        Objects.equals(this.authorizedAt, creditPreauthorizedAdjustmentResponse.authorizedAt) &&
        Objects.equals(this.reasonCode, creditPreauthorizedAdjustmentResponse.reasonCode) &&
        Objects.equals(this.reasonMessage, creditPreauthorizedAdjustmentResponse.reasonMessage) &&
        Objects.equals(this.acquirer, creditPreauthorizedAdjustmentResponse.acquirer) &&
        Objects.equals(this.softDescriptor, creditPreauthorizedAdjustmentResponse.softDescriptor) &&
        Objects.equals(this.terminalNsu, creditPreauthorizedAdjustmentResponse.terminalNsu) &&
        Objects.equals(this.acquirerTransactionId, creditPreauthorizedAdjustmentResponse.acquirerTransactionId) &&
        Objects.equals(this.adjustmentAcquirerTransactionId, creditPreauthorizedAdjustmentResponse.adjustmentAcquirerTransactionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(paymentId, sellerId, amount, currency, orderId, status, authorizationCode, authorizedAt, reasonCode, reasonMessage, acquirer, softDescriptor, terminalNsu, acquirerTransactionId, adjustmentAcquirerTransactionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreditPreauthorizedAdjustmentResponse {\n");
    ...
    sb.append("    adjustmentAcquirerTransactionId: ").append(toIndentedString(adjustmentAcquirerTransactionId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
