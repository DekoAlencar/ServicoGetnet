...
public class AddressBoleto {
  ...
  public AddressBoleto street(String street) {
    this.street = street;
    return this;
  }
   ...
   * @return street
  **/
  @ApiModelProperty(example = "Av. Brasil", required = true, value = "Logradouro.")
  ...
  public AddressBoleto number(String number) {
    this.number = number;
    return this;
  }
   ...
   * @return number
  **/
  @ApiModelProperty(example = "1000", required = true, value = "Número do logradouro.")
  ...
  public AddressBoleto complement(String complement) {
   ...
   * @return complement
  **/
  @ApiModelProperty(example = "Sala 1", value = "Complemento do logradouro.")
  ...
  public AddressBoleto district(String district) {
   ...
   * @return district
  **/
  @ApiModelProperty(example = "São Geraldo", required = true, value = "Bairro.")
  ...
  public AddressBoleto city(String city) {
    this.city = city;
    return this;
  }
   ...
   * @return city
  **/
  @ApiModelProperty(example = "Porto Alegre", required = true, value = "Cidade.")
  ...
  public AddressBoleto state(String state) {
    this.state = state;
    return this;
  }
   ...
   * @return state
  **/
  @ApiModelProperty(example = "RS", required = true, value = "Estado (UF).")
  ...
  public AddressBoleto postalCode(String postalCode) {
   ...
   * @return postalCode
  **/
  @ApiModelProperty(example = "90230060", required = true, value = "Código Postal, CEP no Brasil ou ZIP nos Estados Unidos. (sem máscara)")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AddressBoleto addressBoleto = (AddressBoleto) o;
    return Objects.equals(this.street, addressBoleto.street) &&
        Objects.equals(this.number, addressBoleto.number) &&
        Objects.equals(this.complement, addressBoleto.complement) &&
        Objects.equals(this.district, addressBoleto.district) &&
        Objects.equals(this.city, addressBoleto.city) &&
        Objects.equals(this.state, addressBoleto.state) &&
        Objects.equals(this.postalCode, addressBoleto.postalCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(street, number, complement, district, city, state, postalCode);
  }
