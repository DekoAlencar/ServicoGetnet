...
import br.com.getnet.pagamento.model.PaymentCreditFinalizeDetail;
import java.io.IOException;

/**
 * Conjunto de dados da resposta da finalização do pagamento de crédito autenticado.
 */
@ApiModel(description = "Conjunto de dados da resposta da finalização do pagamento de crédito autenticado.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-01-25T16:02:55.559Z")
public class PaymentCreditFinalizeResponse {
  ...
  @SerializedName("payment_received_timestamp")
  private String paymentReceivedTimestamp = null;

  @SerializedName("credit")
  private PaymentCreditFinalizeDetail credit = null;

  public PaymentCreditFinalizeResponse paymentId(String paymentId) {
  ...
  **/
  ...
  public PaymentCreditFinalizeResponse sellerId(String sellerId) {
  ...
  **/
  ...
  public PaymentCreditFinalizeResponse amount(Integer amount) {
    this.amount = amount;
    return this;
  }
   ...
   * @return amount
  **/
  @ApiModelProperty(example = "100", value = "Valor da compra em centavos.")
  ...
  public PaymentCreditFinalizeResponse currency(String currency) {
  ...
  **/
  ...
  public PaymentCreditFinalizeResponse orderId(String orderId) {
  ...
  **/
  ...
  public PaymentCreditFinalizeResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public PaymentCreditFinalizeResponse paymentReceivedTimestamp(String paymentReceivedTimestamp) {
    this.paymentReceivedTimestamp = paymentReceivedTimestamp;
    return this;
  }

   /**
   * Data e hora do registro de pagamento.
   * @return paymentReceivedTimestamp
  **/
  @ApiModelProperty(example = "2017-03-19T16:30:30.764Z", value = "Data e hora do registro de pagamento.")
  public String getPaymentReceivedTimestamp() {
    return paymentReceivedTimestamp;
  }

  public void setPaymentReceivedTimestamp(String paymentReceivedTimestamp) {
    this.paymentReceivedTimestamp = paymentReceivedTimestamp;
  }

  public PaymentCreditFinalizeResponse credit(PaymentCreditFinalizeDetail credit) {
    this.credit = credit;
    return this;
  }
  ...
  **/
  ...
  public PaymentCreditFinalizeDetail getCredit() {
    return credit;
  }

  public void setCredit(PaymentCreditFinalizeDetail credit) {
    this.credit = credit;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentCreditFinalizeResponse paymentCreditFinalizeResponse = (PaymentCreditFinalizeResponse) o;
    return Objects.equals(this.paymentId, paymentCreditFinalizeResponse.paymentId) &&
        Objects.equals(this.sellerId, paymentCreditFinalizeResponse.sellerId) &&
        Objects.equals(this.amount, paymentCreditFinalizeResponse.amount) &&
        Objects.equals(this.currency, paymentCreditFinalizeResponse.currency) &&
        Objects.equals(this.orderId, paymentCreditFinalizeResponse.orderId) &&
        Objects.equals(this.status, paymentCreditFinalizeResponse.status) &&
        Objects.equals(this.paymentReceivedTimestamp, paymentCreditFinalizeResponse.paymentReceivedTimestamp) &&
        Objects.equals(this.credit, paymentCreditFinalizeResponse.credit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(paymentId, sellerId, amount, currency, orderId, status, paymentReceivedTimestamp, credit);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentCreditFinalizeResponse {\n");
    ...
    sb.append("    paymentReceivedTimestamp: ").append(toIndentedString(paymentReceivedTimestamp)).append("\n");
