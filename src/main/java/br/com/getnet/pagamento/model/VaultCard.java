...
public class VaultCard {
   ...
   * @return numberToken
  **/
  @ApiModelProperty(example = "dfe05208b105578c070f806c80abd3af09e246827d29b866cf4ce16c205849977c9496cbf0d0234f42339937f327747075f68763537b90b31389e01231d4d13c", required = true, value = "Número do cartão tokenizado. Gerado por meio do endpoint /v1/tokens/card.")
  ...
  public VaultCard brand(BrandEnum brand) {
    this.brand = brand;
    return this;
  }
  ...
  **/
  ...
  public VaultCard customerId(String customerId) {
   ...
   /**
   * Identificador do comprador. Informação definida pela aplicação que consome a api da Plataforma Digital. 
   * @return customerId
  **/
  @ApiModelProperty(example = "customer_21081826", required = true, value = "Identificador do comprador. Informação definida pela aplicação que consome a api da Plataforma Digital. ")
  ...
  **/
  @ApiModelProperty(example = "12345678912", value = "Identificação do comprador, como CPF ou RG. (sem máscara)")
  ...
  public VaultCard verifyCard(Boolean verifyCard) {
   ...
   /**
   * Realiza uma transação que Verifica se o cartão informado, não está cancelado, bloqueado ou com restrições.
   * @return verifyCard
  **/
  @ApiModelProperty(example = "false", value = "Realiza uma transação que Verifica se o cartão informado, não está cancelado, bloqueado ou com restrições.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.numberToken, vaultCard.numberToken) &&
        Objects.equals(this.brand, vaultCard.brand) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(numberToken, brand, cardholderName, expirationMonth, expirationYear, customerId, cardholderIdentification, verifyCard, securityCode);
  }
  ...
  public String toString() {
    ...
    sb.append("    cardholderIdentification: ").append(toIndentedString(cardholderIdentification)).append("\n");
    sb.append("    verifyCard: ").append(toIndentedString(verifyCard)).append("\n");
