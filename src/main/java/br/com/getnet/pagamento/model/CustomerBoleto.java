...
public class CustomerBoleto {
  ...
  private AddressBoleto billingAddress = null;

  public CustomerBoleto firstName(String firstName) {
  ...
  **/
  ...
  public CustomerBoleto name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(example = "João da Silva", required = true, value = "Nome completo do comprador. Obrigatório para boleto.")
  ...
  public CustomerBoleto documentType(DocumentTypeEnum documentType) {
   ...
   * @return documentType
  **/
  @ApiModelProperty(example = "CPF", required = true, value = "Tipo do documento de identificação do comprador. Obrigatório para boleto.")
  ...
  public CustomerBoleto documentNumber(String documentNumber) {
  ...
  **/
  @ApiModelProperty(example = "12345678912", required = true, value = "Número do documento do comprador sem pontuação. (sem máscara)")
  ...
  public CustomerBoleto billingAddress(AddressBoleto billingAddress) {
  ...
  **/
  ...
  public AddressBoleto getBillingAddress() {
    return billingAddress;
  }

  public void setBillingAddress(AddressBoleto billingAddress) {
    this.billingAddress = billingAddress;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CustomerBoleto customerBoleto = (CustomerBoleto) o;
    return Objects.equals(this.firstName, customerBoleto.firstName) &&
        Objects.equals(this.name, customerBoleto.name) &&
        Objects.equals(this.documentType, customerBoleto.documentType) &&
        Objects.equals(this.documentNumber, customerBoleto.documentNumber) &&
        Objects.equals(this.billingAddress, customerBoleto.billingAddress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firstName, name, documentType, documentNumber, billingAddress);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomerBoleto {\n");
