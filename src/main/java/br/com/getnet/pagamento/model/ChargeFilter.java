 ...
 */
@ApiModel(description = "Informações das cobranças.")
...
public class ChargeFilter {
  ...
  public ChargeFilter sellerId(String sellerId) {
  ...
  **/
  ...
  public ChargeFilter chargeId(String chargeId) {
   ...
   * @return chargeId
  **/
  @ApiModelProperty(example = "52bc81b2-f079-4f7b-b63a-f653ff29d794", value = "Identificador da cobrança.")
  ...
  public ChargeFilter subscriptionId(String subscriptionId) {
  ...
  **/
  @ApiModelProperty(example = "5d740ea0-b7d1-42f5-ad64-5a5521e12er9", value = "Identificador da assinatura.")
  ...
  public ChargeFilter customerId(String customerId) {
   ...
   * @return customerId
  **/
  @ApiModelProperty(example = "customer_21081826", value = "Identificador do comprador.")
  ...
  public ChargeFilter planId(String planId) {
    this.planId = planId;
    return this;
  }
   ...
   * @return planId
  **/
  @ApiModelProperty(example = "51995e24-b1ae-4826-8e15-2a568a87abdd", value = "Identificador do plano.")
  ...
  public ChargeFilter paymentId(String paymentId) {
  ...
  **/
  ...
  public ChargeFilter amount(Integer amount) {
    this.amount = amount;
    return this;
  }
   ...
   * @return amount
  **/
  @ApiModelProperty(example = "19990", value = "Valor da cobrança.")
  ...
  public ChargeFilter status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
  **/
  @ApiModelProperty(example = "paid", value = "Status da cobrança.")
  ...
  public ChargeFilter scheduledDate(String scheduledDate) {
    this.scheduledDate = scheduledDate;
    return this;
  }

   /**
   * Data de agendamento da cobrança.
   * @return scheduledDate
  **/
  @ApiModelProperty(example = "2017-04-19T16:30:30Z", value = "Data de agendamento da cobrança.")
  ...
  public ChargeFilter createDate(String createDate) {
   ...
   * @return createDate
  **/
  @ApiModelProperty(example = "2017-03-19T16:30:30Z", value = "Data de criação da cobrança.")
  ...
  public ChargeFilter retryNumber(Integer retryNumber) {
   ...
   * @return retryNumber
  **/
  @ApiModelProperty(example = "1", value = "Número de retentativas.")
  ...
  public ChargeFilter paymentDate(Integer paymentDate) {
    this.paymentDate = paymentDate;
    return this;
  }

   /**
   * Data de pagamento da assinatura de recorrência.
   * @return paymentDate
  **/
  @ApiModelProperty(example = "2017-04-19T16:30:30Z", value = "Data de pagamento da assinatura de recorrência.")
  ...
  public ChargeFilter paymentType(String paymentType) {
   ...
   * @return paymentType
  **/
  @ApiModelProperty(example = "credit_card", value = "Tipo de pagamento.")
  ...
  public ChargeFilter terminalNsu(String terminalNsu) {
  ...
  **/
  ...
  public ChargeFilter authorizationCode(String authorizationCode) {
  ...
  **/
  @ApiModelProperty(example = "6964722471672911", value = "Número de autorização gerado pelo sistema de verificação de cartão.")
  ...
  public ChargeFilter acquirerTransactionId(String acquirerTransactionId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ChargeFilter chargeFilter = (ChargeFilter) o;
    return Objects.equals(this.sellerId, chargeFilter.sellerId) &&
        Objects.equals(this.chargeId, chargeFilter.chargeId) &&
        Objects.equals(this.subscriptionId, chargeFilter.subscriptionId) &&
        Objects.equals(this.customerId, chargeFilter.customerId) &&
        Objects.equals(this.planId, chargeFilter.planId) &&
        Objects.equals(this.paymentId, chargeFilter.paymentId) &&
        Objects.equals(this.amount, chargeFilter.amount) &&
        Objects.equals(this.status, chargeFilter.status) &&
        Objects.equals(this.scheduledDate, chargeFilter.scheduledDate) &&
        Objects.equals(this.createDate, chargeFilter.createDate) &&
        Objects.equals(this.retryNumber, chargeFilter.retryNumber) &&
        Objects.equals(this.paymentDate, chargeFilter.paymentDate) &&
        Objects.equals(this.paymentType, chargeFilter.paymentType) &&
        Objects.equals(this.terminalNsu, chargeFilter.terminalNsu) &&
        Objects.equals(this.authorizationCode, chargeFilter.authorizationCode) &&
        Objects.equals(this.acquirerTransactionId, chargeFilter.acquirerTransactionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sellerId, chargeId, subscriptionId, customerId, planId, paymentId, amount, status, scheduledDate, createDate, retryNumber, paymentDate, paymentType, terminalNsu, authorizationCode, acquirerTransactionId);
  }
