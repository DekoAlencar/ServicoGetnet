...
public class CustomerInfo {
  ...
  public CustomerInfo sellerId(String sellerId) {
   ...
   * @return sellerId
  **/
  @ApiModelProperty(example = "6eb2412c-165a-41cd-b1d9-76c575d70a28", required = true, value = "Código de identificação do e-commerce.")
  ...
  public CustomerInfo customerId(String customerId) {
   ...
   /**
   * Identificador do comprador. Caso não seja informado, o sistema irá gerar um identificador no formato uuidv4 de 36 posições.
   * @return customerId
  **/
  @ApiModelProperty(example = "customer_21081826", value = "Identificador do comprador. Caso não seja informado, o sistema irá gerar um identificador no formato uuidv4 de 36 posições.")
   ...
   * @return firstName
  **/
  @ApiModelProperty(example = "João", required = true, value = "Primeiro nome do comprador.")
   ...
   * @return lastName
  **/
  @ApiModelProperty(example = "da Silva", required = true, value = "Último nome do comprador.")
  ...
  public CustomerInfo documentType(DocumentTypeEnum documentType) {
   ...
   * @return documentType
  **/
  @ApiModelProperty(example = "CPF", required = true, value = "Tipo de documento do comprador.")
  ...
  public CustomerInfo documentNumber(String documentNumber) {
  ...
  **/
  @ApiModelProperty(example = "12345678912", required = true, value = "Número do documento do comprador. (sem máscara)")
  ...
  public CustomerInfo birthDate(String birthDate) {
  ...
  **/
  ...
  public CustomerInfo celphoneNumber(String celphoneNumber) {
  ...
  **/
  ...
  public CustomerInfo observation(String observation) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.sellerId, customerInfo.sellerId) &&
        ...
        Objects.equals(this.documentType, customerInfo.documentType) &&
        Objects.equals(this.documentNumber, customerInfo.documentNumber) &&
        Objects.equals(this.birthDate, customerInfo.birthDate) &&
        Objects.equals(this.phoneNumber, customerInfo.phoneNumber) &&
        Objects.equals(this.celphoneNumber, customerInfo.celphoneNumber) &&
        Objects.equals(this.email, customerInfo.email) &&
        Objects.equals(this.observation, customerInfo.observation) &&
        Objects.equals(this.address, customerInfo.address);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sellerId, customerId, firstName, lastName, documentType, documentNumber, birthDate, phoneNumber, celphoneNumber, email, observation, address);
  }
