...
/**
 * Corpo com os dados do boleto.
 */
@ApiModel(description = "Corpo com os dados do boleto.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-01-25T16:02:55.559Z")
public class PaymentBoletoDetail {
  @SerializedName("boleto_id")
  private String boletoId = null;
  ...
  @SerializedName("typeful_line")
  private String typefulLine = null;
  ...
  public PaymentBoletoDetail boletoId(String boletoId) {
   ...
   * @return boletoId
  **/
  @ApiModelProperty(example = "e587cefe-8832-4fc0-acff-acc83dd66e9e", value = "Identificação do boleto.")
  ...
  public PaymentBoletoDetail bank(String bank) {
    this.bank = bank;
    return this;
  }

   /**
   * Número do banco EC. (sem máscara)
   * @return bank
  **/
  @ApiModelProperty(example = "27", value = "Número do banco EC. (sem máscara)")
  ...
  public PaymentBoletoDetail statusCode(BigDecimal statusCode) {
   ...
   * @return statusCode
  **/
  @ApiModelProperty(example = "1.0", value = "Código do status do pagamento.")
  ...
  public PaymentBoletoDetail statusLabel(String statusLabel) {
   ...
   * @return statusLabel
  **/
  @ApiModelProperty(example = "EM ABERTO", value = "Status do pagamento em texto")
  ...
  public PaymentBoletoDetail typefulLine(String typefulLine) {
    this.typefulLine = typefulLine;
    return this;
  }
   ...
   * @return typefulLine
  **/
  @ApiModelProperty(example = "03399.58910 93000.000013 94659.801016 8 71670000030015", value = "Linha digitável do boleto.")
  public String getTypefulLine() {
    return typefulLine;
  }

  public void setTypefulLine(String typefulLine) {
    this.typefulLine = typefulLine;
  }

  public PaymentBoletoDetail barCode(String barCode) {
    this.barCode = barCode;
    return this;
  }

   /**
   * Código de barras do boleto. (sem máscara)
   * @return barCode
  **/
  @ApiModelProperty(example = "03398716700000300159589193000000019465980101", value = "Código de barras do boleto. (sem máscara)")
  ...
  public PaymentBoletoDetail issueDate(String issueDate) {
   ...
   * @return issueDate
  **/
  @ApiModelProperty(example = "17/05/2017", value = "Data de geração do boleto.")
  ...
  public PaymentBoletoDetail expirationDate(String expirationDate) {
  ...
  **/
  @ApiModelProperty(example = "22/05/2017", value = "Data de vencimento do boleto.")
  ...
  public PaymentBoletoDetail ourNumber(String ourNumber) {
    this.ourNumber = ourNumber;
    return this;
  }

   /**
   * Nosso número. (sem máscara)
   * @return ourNumber
  **/
  @ApiModelProperty(example = "000001946598", value = "Nosso número. (sem máscara)")
  ...
  public PaymentBoletoDetail documentNumber(String documentNumber) {
    this.documentNumber = documentNumber;
    return this;
  }

   /**
   * Número do documento controlado pelo cliente. (sem máscara)
   * @return documentNumber
  **/
  @ApiModelProperty(example = "170500000019763", value = "Número do documento controlado pelo cliente. (sem máscara)")
  ...
  public PaymentBoletoDetail links(List<Object> links) {
    this.links = links;
    return this;
  }

  public PaymentBoletoDetail addLinksItem(Object linksItem) {
    if (this.links == null) {
   ...
   * @return links
  **/
  @ApiModelProperty(example = "[{\"href\":\"/v1/payments/boleto/593948e8589f66000ed575e0/pdf\",\"rel\":\"boleto_pdf\",\"type\":\"GET\"},{\"href\":\"/v1/payments/boleto/593948e8589f66000ed575e0/html\",\"rel\":\"boleto_html\",\"type\":\"GET\"}]", value = "")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentBoletoDetail paymentBoletoDetail = (PaymentBoletoDetail) o;
    return Objects.equals(this.boletoId, paymentBoletoDetail.boletoId) &&
        Objects.equals(this.bank, paymentBoletoDetail.bank) &&
        Objects.equals(this.statusCode, paymentBoletoDetail.statusCode) &&
        Objects.equals(this.statusLabel, paymentBoletoDetail.statusLabel) &&
        Objects.equals(this.typefulLine, paymentBoletoDetail.typefulLine) &&
        Objects.equals(this.barCode, paymentBoletoDetail.barCode) &&
        Objects.equals(this.issueDate, paymentBoletoDetail.issueDate) &&
        Objects.equals(this.expirationDate, paymentBoletoDetail.expirationDate) &&
        Objects.equals(this.ourNumber, paymentBoletoDetail.ourNumber) &&
        Objects.equals(this.documentNumber, paymentBoletoDetail.documentNumber) &&
        Objects.equals(this.links, paymentBoletoDetail.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(boletoId, bank, statusCode, statusLabel, typefulLine, barCode, issueDate, expirationDate, ourNumber, documentNumber, links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentBoletoDetail {\n");
    
    sb.append("    boletoId: ").append(toIndentedString(boletoId)).append("\n");
    sb.append("    bank: ").append(toIndentedString(bank)).append("\n");
    sb.append("    statusCode: ").append(toIndentedString(statusCode)).append("\n");
    sb.append("    statusLabel: ").append(toIndentedString(statusLabel)).append("\n");
    sb.append("    typefulLine: ").append(toIndentedString(typefulLine)).append("\n");
