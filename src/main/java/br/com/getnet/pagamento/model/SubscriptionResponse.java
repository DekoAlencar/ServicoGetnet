...
import br.com.getnet.pagamento.model.SubscriptionCustomerResponse;
import br.com.getnet.pagamento.model.SubscriptionPaymentTypeShippingsResponse;
import br.com.getnet.pagamento.model.SubscriptionPlanResponse;
...
public class SubscriptionResponse {
  ...
  @SerializedName("next_scheduled_date")
  private String nextScheduledDate = null;

  @SerializedName("subscription")
  private SubscriptionPaymentTypeShippingsResponse subscription = null;

  @SerializedName("customer")
  private SubscriptionCustomerResponse customer = null;

  @SerializedName("plan")
  private SubscriptionPlanResponse plan = null;

  @SerializedName("device")
  private Device device = null;

  /**
   * Status da assinatura de recorrência.
   */
  ...
  public SubscriptionResponse sellerId(String sellerId) {
  ...
  **/
  ...
  public SubscriptionResponse orderId(String orderId) {
  ...
  **/
  ...
  public SubscriptionResponse createDate(String createDate) {
    this.createDate = createDate;
    return this;
  }

   /**
   * Data de criação da assinatura de recorrência.
   * @return createDate
  **/
  @ApiModelProperty(example = "2017-04-19T16:30:30Z", value = "Data de criação da assinatura de recorrência.")
  ...
  public SubscriptionResponse endDate(String endDate) {
    this.endDate = endDate;
    return this;
  }

   /**
   * Data final da assnatura de recorrência.
   * @return endDate
  **/
  @ApiModelProperty(example = "2018-04-19T16:30:30Z", value = "Data final da assnatura de recorrência.")
  ...
  public SubscriptionResponse paymentDate(Integer paymentDate) {
  ...
  **/
  ...
  public SubscriptionResponse nextScheduledDate(String nextScheduledDate) {
    this.nextScheduledDate = nextScheduledDate;
    return this;
  }

   /**
   * Próxima data de agendamento da assinatura de recorrência.
   * @return nextScheduledDate
  **/
  @ApiModelProperty(example = "2017-05-19T16:30:30Z", value = "Próxima data de agendamento da assinatura de recorrência.")
  ...
  public SubscriptionResponse subscription(SubscriptionPaymentTypeShippingsResponse subscription) {
  ...
  **/
  ...
  public SubscriptionPaymentTypeShippingsResponse getSubscription() {
    return subscription;
  }

  public void setSubscription(SubscriptionPaymentTypeShippingsResponse subscription) {
    this.subscription = subscription;
  }

  public SubscriptionResponse customer(SubscriptionCustomerResponse customer) {
  ...
  **/
  @ApiModelProperty(value = "")
  public SubscriptionCustomerResponse getCustomer() {
    return customer;
  }

  public void setCustomer(SubscriptionCustomerResponse customer) {
    this.customer = customer;
  }

  public SubscriptionResponse plan(SubscriptionPlanResponse plan) {
    this.plan = plan;
    return this;
  }
  ...
  **/
  ...
  public SubscriptionResponse device(Device device) {
    this.device = device;
    return this;
  }
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(example = "success", value = "Status da assinatura de recorrência.")
  ...
  public SubscriptionResponse statusDetails(String statusDetails) {
    this.statusDetails = statusDetails;
    return this;
  }

   /**
   * Detalhes do status da assinatura de recorrência.
   * @return statusDetails
  **/
  @ApiModelProperty(example = "Assinatura Plano flex criada com sucesso", value = "Detalhes do status da assinatura de recorrência.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.sellerId, subscriptionResponse.sellerId) &&
        Objects.equals(this.orderId, subscriptionResponse.orderId) &&
        Objects.equals(this.createDate, subscriptionResponse.createDate) &&
        Objects.equals(this.endDate, subscriptionResponse.endDate) &&
        Objects.equals(this.paymentDate, subscriptionResponse.paymentDate) &&
        Objects.equals(this.nextScheduledDate, subscriptionResponse.nextScheduledDate) &&
        Objects.equals(this.subscription, subscriptionResponse.subscription) &&
        Objects.equals(this.customer, subscriptionResponse.customer) &&
        Objects.equals(this.plan, subscriptionResponse.plan) &&
        Objects.equals(this.device, subscriptionResponse.device) &&
        Objects.equals(this.status, subscriptionResponse.status) &&
        Objects.equals(this.statusDetails, subscriptionResponse.statusDetails);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sellerId, orderId, createDate, endDate, paymentDate, nextScheduledDate, subscription, customer, plan, device, status, statusDetails);
  }
