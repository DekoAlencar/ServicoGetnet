...
/**
 * Conjunto de dados do cartão a ser verificado.
 */
@ApiModel(description = "Conjunto de dados do cartão a ser verificado.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-01-25T16:02:55.559Z")
public class VerificationCardBody {
  ...
  public VerificationCardBody numberToken(String numberToken) {
   ...
   * @return numberToken
  **/
  @ApiModelProperty(example = "dfe05208b105578c070f806c80abd3af09e246827d29b866cf4ce16c205849977c9496cbf0d0234f42339937f327747075f68763537b90b31389e01231d4d13c", required = true, value = "Número do cartão tokenizado. Gerado previamente por meio do endpoint /v1/tokens/card.")
  ...
  public VerificationCardBody brand(BrandEnum brand) {
    this.brand = brand;
    return this;
  }
   ...
   * @return brand
  **/
  @ApiModelProperty(example = "Mastercard", value = "Bandeira do cartão. Preenchido automaticamente pela API caso não seja informado.")
  ...
  public VerificationCardBody cardholderName(String cardholderName) {
  ...
  **/
  @ApiModelProperty(example = "JOAO DA SILVA", required = true, value = "Nome do comprador impresso no cartão.")
  ...
  public VerificationCardBody expirationMonth(String expirationMonth) {
  ...
  **/
  @ApiModelProperty(example = "12", required = true, value = "Mês de expiração do cartão com dois dígitos.")
  ...
  public VerificationCardBody expirationYear(String expirationYear) {
  ...
  **/
  @ApiModelProperty(example = "20", required = true, value = "Ano de expiração do cartão com dois dígitos.")
  ...
  public VerificationCardBody securityCode(String securityCode) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VerificationCardBody verificationCardBody = (VerificationCardBody) o;
    return Objects.equals(this.numberToken, verificationCardBody.numberToken) &&
        Objects.equals(this.brand, verificationCardBody.brand) &&
        Objects.equals(this.cardholderName, verificationCardBody.cardholderName) &&
        Objects.equals(this.expirationMonth, verificationCardBody.expirationMonth) &&
        Objects.equals(this.expirationYear, verificationCardBody.expirationYear) &&
        Objects.equals(this.securityCode, verificationCardBody.securityCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(numberToken, brand, cardholderName, expirationMonth, expirationYear, securityCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class VerificationCardBody {\n");
