...
public class SubscriptionFilterResponse {
  ...
  public SubscriptionFilterResponse subscriptions(List<SubscriptionResponse> subscriptions) {
    this.subscriptions = subscriptions;
    return this;
  }

  public SubscriptionFilterResponse addSubscriptionsItem(SubscriptionResponse subscriptionsItem) {
   ...
   /**
   * Conjunto de assinaturas de recorrência.
   * @return subscriptions
  **/
  @ApiModelProperty(value = "Conjunto de assinaturas de recorrência.")
  ...
  public SubscriptionFilterResponse page(BigDecimal page) {
    this.page = page;
    return this;
  }
   ...
   * @return page
  **/
  @ApiModelProperty(example = "1.0", value = "Página corrente.")
  ...
  public SubscriptionFilterResponse limit(BigDecimal limit) {
    this.limit = limit;
    return this;
  }
   ...
   * @return limit
  **/
  @ApiModelProperty(example = "10.0", value = "Número de registros por página.")
  ...
  public SubscriptionFilterResponse total(BigDecimal total) {
    this.total = total;
    return this;
  }
   ...
   * @return total
  **/
  @ApiModelProperty(example = "1.0", value = "Total de planos cadastrados.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SubscriptionFilterResponse subscriptionFilterResponse = (SubscriptionFilterResponse) o;
    return Objects.equals(this.subscriptions, subscriptionFilterResponse.subscriptions) &&
        Objects.equals(this.page, subscriptionFilterResponse.page) &&
        Objects.equals(this.limit, subscriptionFilterResponse.limit) &&
        Objects.equals(this.total, subscriptionFilterResponse.total);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subscriptions, page, limit, total);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubscriptionFilterResponse {\n");
