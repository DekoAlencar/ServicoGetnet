...
import br.com.getnet.pagamento.model.PaymentCreditConfirmDetails;
import java.io.IOException;

/**
 * Conjunto de dados da resposta da confirmação de pagamento de crédito tardio.
 */
@ApiModel(description = "Conjunto de dados da resposta da confirmação de pagamento de crédito tardio.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-01-25T16:02:55.559Z")
public class CreditDelayedConfirm {
  ...
  public CreditDelayedConfirm paymentId(String paymentId) {
   ...
   * @return paymentId
  **/
  @ApiModelProperty(example = "331b0b07-6e37-4bd9-a37b-99156cb34104", value = "Código de identificação do pagamento.")
  ...
  public CreditDelayedConfirm sellerId(String sellerId) {
  ...
  **/
  ...
  public CreditDelayedConfirm amount(Integer amount) {
    this.amount = amount;
    return this;
  }
   ...
   * @return amount
  **/
  @ApiModelProperty(example = "200000", value = "Valor da compra em centavos.")
  ...
  public CreditDelayedConfirm currency(String currency) {
  ...
  **/
  ...
  public CreditDelayedConfirm orderId(String orderId) {
   ...
   * @return orderId
  **/
  @ApiModelProperty(example = "order-3", value = "Código de identificação da compra utilizado pelo e-commerce")
  ...
  public CreditDelayedConfirm status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
  **/
  @ApiModelProperty(example = "CONFIRMED", value = "Status da transação. Para mais informações sobre os status de retorno, veja o FAQ:\"https://developers.getnet.com.br/faq\"")
  ...
  public CreditDelayedConfirm creditConfirm(PaymentCreditConfirmDetails creditConfirm) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreditDelayedConfirm creditDelayedConfirm = (CreditDelayedConfirm) o;
