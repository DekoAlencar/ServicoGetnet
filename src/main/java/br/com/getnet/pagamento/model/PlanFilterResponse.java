...
import br.com.getnet.pagamento.model.PlanFilter;
...
public class PlanFilterResponse {
  ...
  private List<PlanFilter> plans = null;
  ...
  public PlanFilterResponse plans(List<PlanFilter> plans) {
    this.plans = plans;
    return this;
  }

  public PlanFilterResponse addPlansItem(PlanFilter plansItem) {
    if (this.plans == null) {
      this.plans = new ArrayList<PlanFilter>();
    }
   ...
   * @return plans
  **/
  @ApiModelProperty(value = "Lista de planos cadastrados.")
  public List<PlanFilter> getPlans() {
    return plans;
  }

  public void setPlans(List<PlanFilter> plans) {
    this.plans = plans;
  }

  public PlanFilterResponse page(BigDecimal page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public PlanFilterResponse limit(BigDecimal limit) {
    this.limit = limit;
    return this;
  }
  ...
  **/
  ...
  public PlanFilterResponse total(BigDecimal total) {
    this.total = total;
    return this;
  }
   ...
   * @return total
  **/
  @ApiModelProperty(example = "1.0", required = true, value = "Total de planos cadastrados.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PlanFilterResponse planFilterResponse = (PlanFilterResponse) o;
    return Objects.equals(this.plans, planFilterResponse.plans) &&
        Objects.equals(this.page, planFilterResponse.page) &&
        Objects.equals(this.limit, planFilterResponse.limit) &&
        Objects.equals(this.total, planFilterResponse.total);
  }

  @Override
  public int hashCode() {
    return Objects.hash(plans, page, limit, total);
  }
  ...
  public String toString() {
    ...
    sb.append("class PlanFilterResponse {\n");
