...
import br.com.getnet.pagamento.model.InlineResponse2002;
import br.com.getnet.pagamento.model.InlineResponse2011;
import br.com.getnet.pagamento.model.VaultCard;
import br.com.getnet.pagamento.model.VaultCardResponse;
...
public class CofreApi {
    ...
    public CofreApi(ApiClient apiClient) {
    ...
    /**
     * Build call for v1CardsCardIdDelete
     ...
     * @param cardId Identificador único do cartão na plataforma digital Getnet. (required)
     ...
     */
    public com.squareup.okhttp.Call v1CardsCardIdDeleteCall(String authorization, String cardId, String sellerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/v1/cards/{card_id}"
    ...
    private com.squareup.okhttp.Call v1CardsCardIdDeleteValidateBeforeCall(String authorization, String cardId, String sellerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling v1CardsCardIdDelete(Async)");
        }
        
        // verify the required parameter 'cardId' is set
        if (cardId == null) {
            throw new ApiException("Missing the required parameter 'cardId' when calling v1CardsCardIdDelete(Async)");
        }
        

        com.squareup.okhttp.Call call = v1CardsCardIdDeleteCall(authorization, cardId, sellerId, progressListener, progressRequestListener);
        return call;
     ...
     * Remove um cartão salvo na plataforma digital Getnet, a partir do card_id.
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param cardId Identificador único do cartão na plataforma digital Getnet. (required)
     * @param sellerId Authorization: Código de identificação do e-commerce. Obrigatório quando o cliente for tratado como Plataforma.  (optional)
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void v1CardsCardIdDelete(String authorization, String cardId, String sellerId) throws ApiException {
        v1CardsCardIdDeleteWithHttpInfo(authorization, cardId, sellerId);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> v1CardsCardIdDeleteWithHttpInfo(String authorization, String cardId, String sellerId) throws ApiException {
        com.squareup.okhttp.Call call = v1CardsCardIdDeleteValidateBeforeCall(authorization, cardId, sellerId, null, null);
        return apiClient.execute(call);
    }

    /**
     * Remove um cartão salvo no cofre (asynchronously)
     * Remove um cartão salvo na plataforma digital Getnet, a partir do card_id.
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param cardId Identificador único do cartão na plataforma digital Getnet. (required)
     * @param sellerId Authorization: Código de identificação do e-commerce. Obrigatório quando o cliente for tratado como Plataforma.  (optional)
     ...
     */
    public com.squareup.okhttp.Call v1CardsCardIdDeleteAsync(String authorization, String cardId, String sellerId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = v1CardsCardIdDeleteValidateBeforeCall(authorization, cardId, sellerId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     * Build call for v1CardsCardIdGet
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param cardId Identificador único do cartão na plataforma digital Getnet. (required)
     * @param sellerId Authorization: Código de identificação do e-commerce. Obrigatório quando o cliente for tratado como Plataforma.  (optional)
     * @param progressListener Progress listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call v1CardsCardIdGetCall(String authorization, String cardId, String sellerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call v1CardsCardIdGetValidateBeforeCall(String authorization, String cardId, String sellerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling v1CardsCardIdGet(Async)");
        }
        
        // verify the required parameter 'cardId' is set
        if (cardId == null) {
            throw new ApiException("Missing the required parameter 'cardId' when calling v1CardsCardIdGet(Async)");
        }
        

        com.squareup.okhttp.Call call = v1CardsCardIdGetCall(authorization, cardId, sellerId, progressListener, progressRequestListener);
        return call;
     ...
     * Obtém os dados do cartão salvo no cofre, a partir do card_id gerado no momento do armazenamento do cartão.
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param cardId Identificador único do cartão na plataforma digital Getnet. (required)
     * @param sellerId Authorization: Código de identificação do e-commerce. Obrigatório quando o cliente for tratado como Plataforma.  (optional)
     * @return VaultCardResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public VaultCardResponse v1CardsCardIdGet(String authorization, String cardId, String sellerId) throws ApiException {
        ApiResponse<VaultCardResponse> resp = v1CardsCardIdGetWithHttpInfo(authorization, cardId, sellerId);
        return resp.getData();
    }
     ...
     * @param cardId Identificador único do cartão na plataforma digital Getnet. (required)
     * @param sellerId Authorization: Código de identificação do e-commerce. Obrigatório quando o cliente for tratado como Plataforma.  (optional)
     * @return ApiResponse&lt;VaultCardResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<VaultCardResponse> v1CardsCardIdGetWithHttpInfo(String authorization, String cardId, String sellerId) throws ApiException {
        com.squareup.okhttp.Call call = v1CardsCardIdGetValidateBeforeCall(authorization, cardId, sellerId, null, null);
        Type localVarReturnType = new TypeToken<VaultCardResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Recupera um cartão salvo no cofre (asynchronously)
     * Obtém os dados do cartão salvo no cofre, a partir do card_id gerado no momento do armazenamento do cartão.
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param cardId Identificador único do cartão na plataforma digital Getnet. (required)
     * @param sellerId Authorization: Código de identificação do e-commerce. Obrigatório quando o cliente for tratado como Plataforma.  (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call v1CardsCardIdGetAsync(String authorization, String cardId, String sellerId, final ApiCallback<VaultCardResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = v1CardsCardIdGetValidateBeforeCall(authorization, cardId, sellerId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<VaultCardResponse>(){}.getType();
     ...
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param customerId Identificador do comprador. Informação definida pela aplicação que consome a api da Plataforma Digital. (required)
     * @param sellerId Authorization: Código de identificação do e-commerce. Obrigatório quando o cliente for tratado como Plataforma.  (optional)
     * @param status Filtro de status dos cartões retornados. Caso não seja informado nenhum filtro, serão retornados os cartões ativos e renovados. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call v1CardsGetCall(String authorization, String customerId, String sellerId, String status, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call v1CardsGetValidateBeforeCall(String authorization, String customerId, String sellerId, String status, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (customerId == null) {
            throw new ApiException("Missing the required parameter 'customerId' when calling v1CardsGet(Async)");
        }
        

        com.squareup.okhttp.Call call = v1CardsGetCall(authorization, customerId, sellerId, status, progressListener, progressRequestListener);
        return call;

    }

    /**
     * Lista de cartões salvos no cofre
     * Retorna uma lista de cartões salvos com base nos dados de identificação do comprador  - customer_id.
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param customerId Identificador do comprador. Informação definida pela aplicação que consome a api da Plataforma Digital. (required)
     * @param sellerId Authorization: Código de identificação do e-commerce. Obrigatório quando o cliente for tratado como Plataforma.  (optional)
     * @param status Filtro de status dos cartões retornados. Caso não seja informado nenhum filtro, serão retornados os cartões ativos e renovados. (optional)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse2002 v1CardsGet(String authorization, String customerId, String sellerId, String status) throws ApiException {
        ApiResponse<InlineResponse2002> resp = v1CardsGetWithHttpInfo(authorization, customerId, sellerId, status);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2002> v1CardsGetWithHttpInfo(String authorization, String customerId, String sellerId, String status) throws ApiException {
        com.squareup.okhttp.Call call = v1CardsGetValidateBeforeCall(authorization, customerId, sellerId, status, null, null);
        Type localVarReturnType = new TypeToken<InlineResponse2002>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Lista de cartões salvos no cofre (asynchronously)
     * Retorna uma lista de cartões salvos com base nos dados de identificação do comprador  - customer_id.
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param customerId Identificador do comprador. Informação definida pela aplicação que consome a api da Plataforma Digital. (required)
     * @param sellerId Authorization: Código de identificação do e-commerce. Obrigatório quando o cliente for tratado como Plataforma.  (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call v1CardsGetAsync(String authorization, String customerId, String sellerId, String status, final ApiCallback<InlineResponse2002> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = v1CardsGetValidateBeforeCall(authorization, customerId, sellerId, status, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse2002>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for v1CardsPost
     * @param contentType Tipo do conteúdo application/json.  (required)
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param vaultCardBody Requisição contendo os dados de cartão para salvamento no cofre. (required)
     * @param sellerId Authorization: Código de identificação do e-commerce.  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call v1CardsPostCall(String contentType, String authorization, VaultCard vaultCardBody, String sellerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = vaultCardBody;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call v1CardsPostValidateBeforeCall(String contentType, String authorization, VaultCard vaultCardBody, String sellerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling v1CardsPost(Async)");
        }
        
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling v1CardsPost(Async)");
        }
        
        // verify the required parameter 'vaultCardBody' is set
        if (vaultCardBody == null) {
            throw new ApiException("Missing the required parameter 'vaultCardBody' when calling v1CardsPost(Async)");
        }
        

        com.squareup.okhttp.Call call = v1CardsPostCall(contentType, authorization, vaultCardBody, sellerId, progressListener, progressRequestListener);
        return call;
     ...
     * Cria um recurso cards dentro da plataforma digital Getnet a partir dos dados de cartão do consumidor, para uso em pagamentos futuros.
     * @param contentType Tipo do conteúdo application/json.  (required)
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param vaultCardBody Requisição contendo os dados de cartão para salvamento no cofre. (required)
     * @param sellerId Authorization: Código de identificação do e-commerce.  (optional)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse2011 v1CardsPost(String contentType, String authorization, VaultCard vaultCardBody, String sellerId) throws ApiException {
        ApiResponse<InlineResponse2011> resp = v1CardsPostWithHttpInfo(contentType, authorization, vaultCardBody, sellerId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2011> v1CardsPostWithHttpInfo(String contentType, String authorization, VaultCard vaultCardBody, String sellerId) throws ApiException {
        com.squareup.okhttp.Call call = v1CardsPostValidateBeforeCall(contentType, authorization, vaultCardBody, sellerId, null, null);
        Type localVarReturnType = new TypeToken<InlineResponse2011>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Armazena os dados de cartão do consumidor no cofre (asynchronously)
     * Cria um recurso cards dentro da plataforma digital Getnet a partir dos dados de cartão do consumidor, para uso em pagamentos futuros.
     * @param contentType Tipo do conteúdo application/json.  (required)
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param vaultCardBody Requisição contendo os dados de cartão para salvamento no cofre. (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call v1CardsPostAsync(String contentType, String authorization, VaultCard vaultCardBody, String sellerId, final ApiCallback<InlineResponse2011> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = v1CardsPostValidateBeforeCall(contentType, authorization, vaultCardBody, sellerId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse2011>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
