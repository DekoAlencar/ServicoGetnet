...
public class AutenticaoApi {
    ...
    /**
     * Build call for authOauthV2TokenPost
     * @param contentType Tipo do conteúdo padrão application/x-www-form-urlencoded.  (required)
     * @param authorization Authorization: Basic *AuthString* &lt;/br&gt; Onde *AuthString* é a concatenação do seu Client ID, seguido de “:” (dois pontos) mais seu Client Secret, convertidos para base64. &lt;br&gt; Como exemplo: Para o Client ID igual a client-01 e Client Secret igual a secret-key-02, teremos o texto client-01:secret-key-02 após a concatenação, convertendo para base64 teremos o resultado 2xpZW50LTAxOnNlY3JldC1rZXktMDI&#x3D;.&lt;/br&gt; Neste caso o  Authorization no header da requisição será: &lt;/br&gt; Authorization: Basic 2xpZW50LTAxOnNlY3JldC1rZXktMDI&#x3D;  (required)
     * @param scope Usar o valor fixo \&quot;oob\&quot; (required)
     * @param grantType Usar O valor fixo \&quot;client_credentials\&quot; (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call authOauthV2TokenPostCall(String contentType, String authorization, String scope, String grantType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call authOauthV2TokenPostValidateBeforeCall(String contentType, String authorization, String scope, String grantType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling authOauthV2TokenPost(Async)");
        }
        
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling authOauthV2TokenPost(Async)");
        }
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling authOauthV2TokenPost(Async)");
        }
        
        // verify the required parameter 'grantType' is set
        if (grantType == null) {
            throw new ApiException("Missing the required parameter 'grantType' when calling authOauthV2TokenPost(Async)");
        }
        

        com.squareup.okhttp.Call call = authOauthV2TokenPostCall(contentType, authorization, scope, grantType, progressListener, progressRequestListener);
        return call;
     ...
     * Endpoint responsável pela geração do token de acesso utilizado nas demais requisições, para isso utilizamos [HTTP Basic Authentication](https://www.w3.org/Protocols/HTTP/1.0/draft-ietf-http-spec.html#BasicAA)
     * @param contentType Tipo do conteúdo padrão application/x-www-form-urlencoded.  (required)
     * @param authorization Authorization: Basic *AuthString* &lt;/br&gt; Onde *AuthString* é a concatenação do seu Client ID, seguido de “:” (dois pontos) mais seu Client Secret, convertidos para base64. &lt;br&gt; Como exemplo: Para o Client ID igual a client-01 e Client Secret igual a secret-key-02, teremos o texto client-01:secret-key-02 após a concatenação, convertendo para base64 teremos o resultado 2xpZW50LTAxOnNlY3JldC1rZXktMDI&#x3D;.&lt;/br&gt; Neste caso o  Authorization no header da requisição será: &lt;/br&gt; Authorization: Basic 2xpZW50LTAxOnNlY3JldC1rZXktMDI&#x3D;  (required)
     * @param scope Usar o valor fixo \&quot;oob\&quot; (required)
     * @param grantType Usar O valor fixo \&quot;client_credentials\&quot; (required)
     ...
     */
    public InlineResponse200 authOauthV2TokenPost(String contentType, String authorization, String scope, String grantType) throws ApiException {
        ApiResponse<InlineResponse200> resp = authOauthV2TokenPostWithHttpInfo(contentType, authorization, scope, grantType);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse200> authOauthV2TokenPostWithHttpInfo(String contentType, String authorization, String scope, String grantType) throws ApiException {
        com.squareup.okhttp.Call call = authOauthV2TokenPostValidateBeforeCall(contentType, authorization, scope, grantType, null, null);
        Type localVarReturnType = new TypeToken<InlineResponse200>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Geração do token de acesso (asynchronously)
     * Endpoint responsável pela geração do token de acesso utilizado nas demais requisições, para isso utilizamos [HTTP Basic Authentication](https://www.w3.org/Protocols/HTTP/1.0/draft-ietf-http-spec.html#BasicAA)
     * @param contentType Tipo do conteúdo padrão application/x-www-form-urlencoded.  (required)
     * @param authorization Authorization: Basic *AuthString* &lt;/br&gt; Onde *AuthString* é a concatenação do seu Client ID, seguido de “:” (dois pontos) mais seu Client Secret, convertidos para base64. &lt;br&gt; Como exemplo: Para o Client ID igual a client-01 e Client Secret igual a secret-key-02, teremos o texto client-01:secret-key-02 após a concatenação, convertendo para base64 teremos o resultado 2xpZW50LTAxOnNlY3JldC1rZXktMDI&#x3D;.&lt;/br&gt; Neste caso o  Authorization no header da requisição será: &lt;/br&gt; Authorization: Basic 2xpZW50LTAxOnNlY3JldC1rZXktMDI&#x3D;  (required)
     * @param scope Usar o valor fixo \&quot;oob\&quot; (required)
     ...
     */
    public com.squareup.okhttp.Call authOauthV2TokenPostAsync(String contentType, String authorization, String scope, String grantType, final ApiCallback<InlineResponse200> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = authOauthV2TokenPostValidateBeforeCall(contentType, authorization, scope, grantType, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse200>(){}.getType();
