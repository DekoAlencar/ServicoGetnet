...
public class CancelamentoApi {
    private ApiClient apiClient;

    public CancelamentoApi() {
        this(Configuration.getDefaultApiClient());
    }

    public CancelamentoApi(ApiClient apiClient) {
    ...
    /**
     * Build call for v1PaymentsCancelRequestCancelRequestIdGet
     ...
     * @param cancelRequestId Identificador da solicitação de cancelamento. (required)
     * @param sellerId Código de identificação do e-commerce. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call v1PaymentsCancelRequestCancelRequestIdGetCall(String authorization, String cancelRequestId, String sellerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/v1/payments/cancel/request/{cancel_request_id}"
            .replaceAll("\\{" + "cancel_request_id" + "\\}", apiClient.escapeString(cancelRequestId.toString()));
    ...
    private com.squareup.okhttp.Call v1PaymentsCancelRequestCancelRequestIdGetValidateBeforeCall(String authorization, String cancelRequestId, String sellerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling v1PaymentsCancelRequestCancelRequestIdGet(Async)");
        }
        
        // verify the required parameter 'cancelRequestId' is set
        if (cancelRequestId == null) {
            throw new ApiException("Missing the required parameter 'cancelRequestId' when calling v1PaymentsCancelRequestCancelRequestIdGet(Async)");
        }
        

        com.squareup.okhttp.Call call = v1PaymentsCancelRequestCancelRequestIdGetCall(authorization, cancelRequestId, sellerId, progressListener, progressRequestListener);
        return call;

    }

    /**
     * Retorna uma solicitação de cancelamento pelo identificador
     * Retorna os dados da solicitação de cancelamento pelo identificador.
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param cancelRequestId Identificador da solicitação de cancelamento. (required)
     * @param sellerId Código de identificação do e-commerce. (optional)
     ...
     */
    public CancelQueryResponse v1PaymentsCancelRequestCancelRequestIdGet(String authorization, String cancelRequestId, String sellerId) throws ApiException {
        ApiResponse<CancelQueryResponse> resp = v1PaymentsCancelRequestCancelRequestIdGetWithHttpInfo(authorization, cancelRequestId, sellerId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CancelQueryResponse> v1PaymentsCancelRequestCancelRequestIdGetWithHttpInfo(String authorization, String cancelRequestId, String sellerId) throws ApiException {
        com.squareup.okhttp.Call call = v1PaymentsCancelRequestCancelRequestIdGetValidateBeforeCall(authorization, cancelRequestId, sellerId, null, null);
        Type localVarReturnType = new TypeToken<CancelQueryResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Retorna uma solicitação de cancelamento pelo identificador (asynchronously)
     * Retorna os dados da solicitação de cancelamento pelo identificador.
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param cancelRequestId Identificador da solicitação de cancelamento. (required)
     * @param sellerId Código de identificação do e-commerce. (optional)
     ...
     */
    public com.squareup.okhttp.Call v1PaymentsCancelRequestCancelRequestIdGetAsync(String authorization, String cancelRequestId, String sellerId, final ApiCallback<CancelQueryResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = v1PaymentsCancelRequestCancelRequestIdGetValidateBeforeCall(authorization, cancelRequestId, sellerId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CancelQueryResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for v1PaymentsCancelRequestGet
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param cancelCustomKey Chave gerada pelo cliente para a solicitação de cancelamento. (required)
     * @param sellerId Código de identificação do e-commerce. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call v1PaymentsCancelRequestGetCall(String authorization, String cancelCustomKey, String sellerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/v1/payments/cancel/request";

        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (cancelCustomKey != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("cancel_custom_key", cancelCustomKey));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call v1PaymentsCancelRequestGetValidateBeforeCall(String authorization, String cancelCustomKey, String sellerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling v1PaymentsCancelRequestGet(Async)");
        }
        
        // verify the required parameter 'cancelCustomKey' is set
        if (cancelCustomKey == null) {
            throw new ApiException("Missing the required parameter 'cancelCustomKey' when calling v1PaymentsCancelRequestGet(Async)");
        }
        

        com.squareup.okhttp.Call call = v1PaymentsCancelRequestGetCall(authorization, cancelCustomKey, sellerId, progressListener, progressRequestListener);
        return call;

    }

    /**
     * Retorna uma solicitação de cancelamento pela chave do cliente
     * Retorna os dados da solicitação de cancelamento pela chave gerada pelo cliente.
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param cancelCustomKey Chave gerada pelo cliente para a solicitação de cancelamento. (required)
     * @param sellerId Código de identificação do e-commerce. (optional)
     * @return CancelQueryResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public CancelQueryResponse v1PaymentsCancelRequestGet(String authorization, String cancelCustomKey, String sellerId) throws ApiException {
        ApiResponse<CancelQueryResponse> resp = v1PaymentsCancelRequestGetWithHttpInfo(authorization, cancelCustomKey, sellerId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CancelQueryResponse> v1PaymentsCancelRequestGetWithHttpInfo(String authorization, String cancelCustomKey, String sellerId) throws ApiException {
        com.squareup.okhttp.Call call = v1PaymentsCancelRequestGetValidateBeforeCall(authorization, cancelCustomKey, sellerId, null, null);
        Type localVarReturnType = new TypeToken<CancelQueryResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Retorna uma solicitação de cancelamento pela chave do cliente (asynchronously)
     * Retorna os dados da solicitação de cancelamento pela chave gerada pelo cliente.
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param cancelCustomKey Chave gerada pelo cliente para a solicitação de cancelamento. (required)
     * @param sellerId Código de identificação do e-commerce. (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call v1PaymentsCancelRequestGetAsync(String authorization, String cancelCustomKey, String sellerId, final ApiCallback<CancelQueryResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = v1PaymentsCancelRequestGetValidateBeforeCall(authorization, cancelCustomKey, sellerId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CancelQueryResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for v1PaymentsCancelRequestPost
     * @param contentType Tipo do conteúdo application/json. (required)
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param body Requisição contendo os dados para uma solicitação de cancelamento. (required)
     * @param sellerId Código de identificação do e-commerce. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call v1PaymentsCancelRequestPostCall(String contentType, String authorization, CancelRequest body, String sellerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call v1PaymentsCancelRequestPostValidateBeforeCall(String contentType, String authorization, CancelRequest body, String sellerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling v1PaymentsCancelRequestPost(Async)");
        }
        
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling v1PaymentsCancelRequestPost(Async)");
        }
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling v1PaymentsCancelRequestPost(Async)");
        }
        

        com.squareup.okhttp.Call call = v1PaymentsCancelRequestPostCall(contentType, authorization, body, sellerId, progressListener, progressRequestListener);
        return call;

    }

    /**
     * Solicita um cancelamento
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public CancelRequestResponse v1PaymentsCancelRequestPost(String contentType, String authorization, CancelRequest body, String sellerId) throws ApiException {
        ApiResponse<CancelRequestResponse> resp = v1PaymentsCancelRequestPostWithHttpInfo(contentType, authorization, body, sellerId);
        return resp.getData();
    }
     ...
     * @param body Requisição contendo os dados para uma solicitação de cancelamento. (required)
     * @param sellerId Código de identificação do e-commerce. (optional)
     * @return ApiResponse&lt;CancelRequestResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CancelRequestResponse> v1PaymentsCancelRequestPostWithHttpInfo(String contentType, String authorization, CancelRequest body, String sellerId) throws ApiException {
        com.squareup.okhttp.Call call = v1PaymentsCancelRequestPostValidateBeforeCall(contentType, authorization, body, sellerId, null, null);
        Type localVarReturnType = new TypeToken<CancelRequestResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Solicita um cancelamento (asynchronously)
     *  * Solicita o cancelamento de transações que foram realizadas há mais de 1 dia (D+n).
     * @param contentType Tipo do conteúdo application/json. (required)
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param body Requisição contendo os dados para uma solicitação de cancelamento. (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call v1PaymentsCancelRequestPostAsync(String contentType, String authorization, CancelRequest body, String sellerId, final ApiCallback<CancelRequestResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = v1PaymentsCancelRequestPostValidateBeforeCall(contentType, authorization, body, sellerId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CancelRequestResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
