...
import br.com.getnet.pagamento.model.Plan;
import br.com.getnet.pagamento.model.PlanFilterResponse;
import br.com.getnet.pagamento.model.PlanResponse;
import br.com.getnet.pagamento.model.PlanUpdate;
...
public class PlanosApi {
    ...
    public PlanosApi(ApiClient apiClient) {
     ...
     * @param planId Identificador do plano. (optional)
     * @param status Status do plano. (optional, default to active)
     * @param name Nome do plano. (optional)
     * @param sort Campo para realizar a ordenação. (optional, default to name)
     ...
     */
    public com.squareup.okhttp.Call v1PlansGetCall(String authorization, String sellerId, BigDecimal page, BigDecimal limit, String planId, String status, String name, String sort, String sortType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call v1PlansGetValidateBeforeCall(String authorization, String sellerId, BigDecimal page, BigDecimal limit, String planId, String status, String name, String sort, String sortType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling v1PlansGet(Async)");
        }
        
        // verify the required parameter 'sellerId' is set
        if (sellerId == null) {
            throw new ApiException("Missing the required parameter 'sellerId' when calling v1PlansGet(Async)");
        }
        
        // verify the required parameter 'page' is set
        if (page == null) {
            throw new ApiException("Missing the required parameter 'page' when calling v1PlansGet(Async)");
        }
        
        // verify the required parameter 'limit' is set
        if (limit == null) {
            throw new ApiException("Missing the required parameter 'limit' when calling v1PlansGet(Async)");
        }
        

        com.squareup.okhttp.Call call = v1PlansGetCall(authorization, sellerId, page, limit, planId, status, name, sort, sortType, progressListener, progressRequestListener);
        return call;
    ...
    /**
     * Lista de planos
     * Retorna uma lista de planos de recorrência cadastrados com base nos filtros escolhidos.
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param sellerId Código de identificação do e-commerce. (required)
     * @param page Número da página em que inicia a paginação. (required)
     * @param limit Limite de resultados por página. (required)
     ...
     * @param sort Campo para realizar a ordenação. (optional, default to name)
     * @param sortType Tipo de ordenação. Ascendente ou Descendente. (optional)
     * @return PlanFilterResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PlanFilterResponse v1PlansGet(String authorization, String sellerId, BigDecimal page, BigDecimal limit, String planId, String status, String name, String sort, String sortType) throws ApiException {
        ApiResponse<PlanFilterResponse> resp = v1PlansGetWithHttpInfo(authorization, sellerId, page, limit, planId, status, name, sort, sortType);
        return resp.getData();
    }
     ...
     * @param sort Campo para realizar a ordenação. (optional, default to name)
     * @param sortType Tipo de ordenação. Ascendente ou Descendente. (optional)
     * @return ApiResponse&lt;PlanFilterResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PlanFilterResponse> v1PlansGetWithHttpInfo(String authorization, String sellerId, BigDecimal page, BigDecimal limit, String planId, String status, String name, String sort, String sortType) throws ApiException {
        com.squareup.okhttp.Call call = v1PlansGetValidateBeforeCall(authorization, sellerId, page, limit, planId, status, name, sort, sortType, null, null);
        Type localVarReturnType = new TypeToken<PlanFilterResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Lista de planos (asynchronously)
     * Retorna uma lista de planos de recorrência cadastrados com base nos filtros escolhidos.
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param sellerId Código de identificação do e-commerce. (required)
     * @param page Número da página em que inicia a paginação. (required)
     ...
     */
    public com.squareup.okhttp.Call v1PlansGetAsync(String authorization, String sellerId, BigDecimal page, BigDecimal limit, String planId, String status, String name, String sort, String sortType, final ApiCallback<PlanFilterResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = v1PlansGetValidateBeforeCall(authorization, sellerId, page, limit, planId, status, name, sort, sortType, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PlanFilterResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for v1PlansPlanIdGet
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param sellerId Código de identificação do e-commerce. (required)
     * @param planId Identificador do plano. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call v1PlansPlanIdGetCall(String authorization, String sellerId, String planId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/v1/plans/{plan_id}"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call v1PlansPlanIdGetValidateBeforeCall(String authorization, String sellerId, String planId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling v1PlansPlanIdGet(Async)");
        }
        
        // verify the required parameter 'sellerId' is set
        if (sellerId == null) {
            throw new ApiException("Missing the required parameter 'sellerId' when calling v1PlansPlanIdGet(Async)");
        }
        
        // verify the required parameter 'planId' is set
        if (planId == null) {
            throw new ApiException("Missing the required parameter 'planId' when calling v1PlansPlanIdGet(Async)");
        }
        

        com.squareup.okhttp.Call call = v1PlansPlanIdGetCall(authorization, sellerId, planId, progressListener, progressRequestListener);
        return call;
    ...
    /**
     * Retorna um plano
     * Retorna um plano de recorrência pelo identificador.
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param sellerId Código de identificação do e-commerce. (required)
     * @param planId Identificador do plano. (required)
     * @return PlanResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PlanResponse v1PlansPlanIdGet(String authorization, String sellerId, String planId) throws ApiException {
        ApiResponse<PlanResponse> resp = v1PlansPlanIdGetWithHttpInfo(authorization, sellerId, planId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PlanResponse> v1PlansPlanIdGetWithHttpInfo(String authorization, String sellerId, String planId) throws ApiException {
        com.squareup.okhttp.Call call = v1PlansPlanIdGetValidateBeforeCall(authorization, sellerId, planId, null, null);
        Type localVarReturnType = new TypeToken<PlanResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Retorna um plano (asynchronously)
     * Retorna um plano de recorrência pelo identificador.
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param sellerId Código de identificação do e-commerce. (required)
     * @param planId Identificador do plano. (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call v1PlansPlanIdGetAsync(String authorization, String sellerId, String planId, final ApiCallback<PlanResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = v1PlansPlanIdGetValidateBeforeCall(authorization, sellerId, planId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PlanResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for v1PlansPlanIdPatch
     * @param contentType Tipo do conteúdo application/json. (required)
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param sellerId Código de identificação do e-commerce. (required)
     * @param planId Identificador do plano. (required)
     * @param body Conjunto de dados do plano a ser atualizado. (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call v1PlansPlanIdPatchCall(String contentType, String authorization, String sellerId, String planId, PlanUpdate body, String username, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call v1PlansPlanIdPatchValidateBeforeCall(String contentType, String authorization, String sellerId, String planId, PlanUpdate body, String username, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling v1PlansPlanIdPatch(Async)");
        }
        
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling v1PlansPlanIdPatch(Async)");
        }
        
        // verify the required parameter 'sellerId' is set
        if (sellerId == null) {
            throw new ApiException("Missing the required parameter 'sellerId' when calling v1PlansPlanIdPatch(Async)");
        }
        
        // verify the required parameter 'planId' is set
        if (planId == null) {
            throw new ApiException("Missing the required parameter 'planId' when calling v1PlansPlanIdPatch(Async)");
        }
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling v1PlansPlanIdPatch(Async)");
        }
        

        com.squareup.okhttp.Call call = v1PlansPlanIdPatchCall(contentType, authorization, sellerId, planId, body, username, progressListener, progressRequestListener);
        return call;
    ...
    /**
     * Atualiza um plano
     * Atualiza um plano de recorrência pelo identificador.
     * @param contentType Tipo do conteúdo application/json. (required)
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param sellerId Código de identificação do e-commerce. (required)
     * @param planId Identificador do plano. (required)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PlanResponse v1PlansPlanIdPatch(String contentType, String authorization, String sellerId, String planId, PlanUpdate body, String username) throws ApiException {
        ApiResponse<PlanResponse> resp = v1PlansPlanIdPatchWithHttpInfo(contentType, authorization, sellerId, planId, body, username);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PlanResponse> v1PlansPlanIdPatchWithHttpInfo(String contentType, String authorization, String sellerId, String planId, PlanUpdate body, String username) throws ApiException {
        com.squareup.okhttp.Call call = v1PlansPlanIdPatchValidateBeforeCall(contentType, authorization, sellerId, planId, body, username, null, null);
        Type localVarReturnType = new TypeToken<PlanResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Atualiza um plano (asynchronously)
     * Atualiza um plano de recorrência pelo identificador.
     * @param contentType Tipo do conteúdo application/json. (required)
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param sellerId Código de identificação do e-commerce. (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call v1PlansPlanIdPatchAsync(String contentType, String authorization, String sellerId, String planId, PlanUpdate body, String username, final ApiCallback<PlanResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = v1PlansPlanIdPatchValidateBeforeCall(contentType, authorization, sellerId, planId, body, username, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PlanResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for v1PlansPlanIdStatusStatusPatch
     * @param contentType Tipo do conteúdo application/json. (required)
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param sellerId Código de identificação do e-commerce. (required)
     * @param planId Identificador do plano. (required)
     * @param status Status do plano. (required)
     * @param username Usuário que está realizando o cadastro. Esta informação pode ser utilizada para fins de auditoria. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call v1PlansPlanIdStatusStatusPatchCall(String contentType, String authorization, String sellerId, String planId, String status, String username, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/v1/plans/{plan_id}/status/{status}"
            .replaceAll("\\{" + "plan_id" + "\\}", apiClient.escapeString(planId.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call v1PlansPlanIdStatusStatusPatchValidateBeforeCall(String contentType, String authorization, String sellerId, String planId, String status, String username, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling v1PlansPlanIdStatusStatusPatch(Async)");
        }
        
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling v1PlansPlanIdStatusStatusPatch(Async)");
        }
        
        // verify the required parameter 'sellerId' is set
        if (sellerId == null) {
            throw new ApiException("Missing the required parameter 'sellerId' when calling v1PlansPlanIdStatusStatusPatch(Async)");
        }
        
        // verify the required parameter 'planId' is set
        if (planId == null) {
            throw new ApiException("Missing the required parameter 'planId' when calling v1PlansPlanIdStatusStatusPatch(Async)");
        }
        
        // verify the required parameter 'status' is set
        if (status == null) {
            throw new ApiException("Missing the required parameter 'status' when calling v1PlansPlanIdStatusStatusPatch(Async)");
        }
        

        com.squareup.okhttp.Call call = v1PlansPlanIdStatusStatusPatchCall(contentType, authorization, sellerId, planId, status, username, progressListener, progressRequestListener);
        return call;
     ...
     * Atualiza o status do plano de recorrência pelo identificador.
     * @param contentType Tipo do conteúdo application/json. (required)
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param sellerId Código de identificação do e-commerce. (required)
     * @param planId Identificador do plano. (required)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PlanResponse v1PlansPlanIdStatusStatusPatch(String contentType, String authorization, String sellerId, String planId, String status, String username) throws ApiException {
        ApiResponse<PlanResponse> resp = v1PlansPlanIdStatusStatusPatchWithHttpInfo(contentType, authorization, sellerId, planId, status, username);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PlanResponse> v1PlansPlanIdStatusStatusPatchWithHttpInfo(String contentType, String authorization, String sellerId, String planId, String status, String username) throws ApiException {
        com.squareup.okhttp.Call call = v1PlansPlanIdStatusStatusPatchValidateBeforeCall(contentType, authorization, sellerId, planId, status, username, null, null);
        Type localVarReturnType = new TypeToken<PlanResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Atualiza o status do plano (asynchronously)
     * Atualiza o status do plano de recorrência pelo identificador.
     * @param contentType Tipo do conteúdo application/json. (required)
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param sellerId Código de identificação do e-commerce. (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call v1PlansPlanIdStatusStatusPatchAsync(String contentType, String authorization, String sellerId, String planId, String status, String username, final ApiCallback<PlanResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = v1PlansPlanIdStatusStatusPatchValidateBeforeCall(contentType, authorization, sellerId, planId, status, username, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PlanResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for v1PlansPost
     * @param contentType Tipo do conteúdo application/json. (required)
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param sellerId Código de identificação do e-commerce. (required)
     * @param body Requisição contendo os dados para cadastro de um novo plano. (required)
     * @param username Usuário que está realizando o cadastro. Esta informação pode ser utilizada para fins de auditoria. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call v1PlansPostCall(String contentType, String authorization, String sellerId, Plan body, String username, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call v1PlansPostValidateBeforeCall(String contentType, String authorization, String sellerId, Plan body, String username, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling v1PlansPost(Async)");
        }
        
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling v1PlansPost(Async)");
        }
        
        // verify the required parameter 'sellerId' is set
        if (sellerId == null) {
            throw new ApiException("Missing the required parameter 'sellerId' when calling v1PlansPost(Async)");
        }
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling v1PlansPost(Async)");
        }
        

        com.squareup.okhttp.Call call = v1PlansPostCall(contentType, authorization, sellerId, body, username, progressListener, progressRequestListener);
        return call;
     ...
     * Cadastra um novo plano de recorrência.
     * @param contentType Tipo do conteúdo application/json. (required)
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param sellerId Código de identificação do e-commerce. (required)
     * @param body Requisição contendo os dados para cadastro de um novo plano. (required)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PlanResponse v1PlansPost(String contentType, String authorization, String sellerId, Plan body, String username) throws ApiException {
        ApiResponse<PlanResponse> resp = v1PlansPostWithHttpInfo(contentType, authorization, sellerId, body, username);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PlanResponse> v1PlansPostWithHttpInfo(String contentType, String authorization, String sellerId, Plan body, String username) throws ApiException {
        com.squareup.okhttp.Call call = v1PlansPostValidateBeforeCall(contentType, authorization, sellerId, body, username, null, null);
        Type localVarReturnType = new TypeToken<PlanResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Cadastra um novo plano (asynchronously)
     * Cadastra um novo plano de recorrência.
     * @param contentType Tipo do conteúdo application/json. (required)
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param sellerId Código de identificação do e-commerce. (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call v1PlansPostAsync(String contentType, String authorization, String sellerId, Plan body, String username, final ApiCallback<PlanResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = v1PlansPostValidateBeforeCall(contentType, authorization, sellerId, body, username, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PlanResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
