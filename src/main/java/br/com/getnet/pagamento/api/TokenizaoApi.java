...
public class TokenizaoApi {
    ...
    public TokenizaoApi(ApiClient apiClient) {
    ...
    /**
     * Build call for v1TokensCardPost
     ...
     * @param tokenCard Dados do cartão e do comprador (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call v1TokensCardPostCall(String contentType, String authorization, String sellerId, TokenCard tokenCard, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = tokenCard;

        // create path and map variables
        String localVarPath = "/v1/tokens/card";
    ...
    private com.squareup.okhttp.Call v1TokensCardPostValidateBeforeCall(String contentType, String authorization, String sellerId, TokenCard tokenCard, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'contentType' is set
        if (contentType == null) {
            throw new ApiException("Missing the required parameter 'contentType' when calling v1TokensCardPost(Async)");
        }
        
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling v1TokensCardPost(Async)");
        }
        

        com.squareup.okhttp.Call call = v1TokensCardPostCall(contentType, authorization, sellerId, tokenCard, progressListener, progressRequestListener);
        return call;
     ...
     * Para efetuar transações de forma segura os dados do cartão, exceto CVV, devem ser *tokenizados*, esse processo é feito pelo endpoint descrito abaixo mediante autenticação.
     * @param contentType Tipo do conteúdo application/json.  (required)
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param sellerId Authorization: Código de identificação do e-commerce. Obrigatório quando o cliente for tratado como Plataforma.  (optional)
     * @param tokenCard Dados do cartão e do comprador (optional)
     ...
     */
    public InlineResponse201 v1TokensCardPost(String contentType, String authorization, String sellerId, TokenCard tokenCard) throws ApiException {
        ApiResponse<InlineResponse201> resp = v1TokensCardPostWithHttpInfo(contentType, authorization, sellerId, tokenCard);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse201> v1TokensCardPostWithHttpInfo(String contentType, String authorization, String sellerId, TokenCard tokenCard) throws ApiException {
        com.squareup.okhttp.Call call = v1TokensCardPostValidateBeforeCall(contentType, authorization, sellerId, tokenCard, null, null);
        Type localVarReturnType = new TypeToken<InlineResponse201>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Geração do token do cartão (asynchronously)
     * Para efetuar transações de forma segura os dados do cartão, exceto CVV, devem ser *tokenizados*, esse processo é feito pelo endpoint descrito abaixo mediante autenticação.
     * @param contentType Tipo do conteúdo application/json.  (required)
     * @param authorization Authorization: Bearer *AuthString* &lt;/br&gt; Onde *AuthString* é token de acesso obtido no endpoint de autenticação.  (required)
     * @param sellerId Authorization: Código de identificação do e-commerce. Obrigatório quando o cliente for tratado como Plataforma.  (optional)
     ...
     */
    public com.squareup.okhttp.Call v1TokensCardPostAsync(String contentType, String authorization, String sellerId, TokenCard tokenCard, final ApiCallback<InlineResponse201> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = v1TokensCardPostValidateBeforeCall(contentType, authorization, sellerId, tokenCard, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse201>(){}.getType();
